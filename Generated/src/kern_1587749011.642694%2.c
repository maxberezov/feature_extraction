...
/*
 * file for kern_1587749011.642694.c
 */
...
inner:      LU_NUB0 = 13;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         C[LU_IND0*1+0][LU_IND0*1+0][LU_IND0*1+0] = 19;
         C[LU_IND0*1+0+1][LU_IND0*1+0][LU_IND0*1+0+3] = 7;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         C[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0][(LU_IND0+0)*1+0] = 19;
         C[(LU_IND0+0)*1+0+1][(LU_IND0+0)*1+0][(LU_IND0+0)*1+0+3] = 7;
         C[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0][(LU_IND0+1)*1+0] = 19;
         C[(LU_IND0+1)*1+0+1][(LU_IND0+1)*1+0][(LU_IND0+1)*1+0+3] = 7;
l99998:         ;
      }
