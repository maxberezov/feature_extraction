...
/*
 * file for kern_1587749000.172829.c
 */
...
inner:               LU_NUB0 = 65529;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+2] = B[LU_IND0*1+2-2]-7;
                  B[LU_IND0*1+2] = B[LU_IND0*1+2+4]+32;
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2-2]-7;
                  B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+4]+32;
                  B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2-2]-7;
                  B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+4]+32;
l99998:                  ;
               }
