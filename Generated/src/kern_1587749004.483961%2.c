...
/*
 * file for kern_1587749004.483961.c
 */
...
inner:         LU_NUB0 = 54;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = A[LU_IND0*1+5][b][LU_IND0*1+5]+44;
            var_b0 = A[LU_IND0*1+5-5][b-2][LU_IND0*1+5-1]-41;
            B[LU_IND0*1+5] = B[LU_IND0*1+5-5]-34;
            A[LU_IND0*1+5][b][LU_IND0*1+5] = A[LU_IND0*1+5+5][b+4][LU_IND0*1+5+1]-14;
            A[LU_IND0*1+5][b][LU_IND0*1+5] = A[LU_IND0*1+5+3][b+1][LU_IND0*1+5+2]-8;
            B[LU_IND0*1+5] = 10;
            var_a0 = A[LU_IND0*1+5][b][LU_IND0*1+5]+44;
...
l99999:            ;
         ...
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = A[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]+44;
            var_b2 = A[(LU_IND0+0)*1+5-5][b-2][(LU_IND0+0)*1+5-1]-41;
            B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-5]-34;
            A[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+5][b+4][(LU_IND0+0)*1+5+1]-14;
            A[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+3][b+1][(LU_IND0+0)*1+5+2]-8;
            B[(LU_IND0+0)*1+5] = 10;
            var_a2 = A[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]+44;

            var_b2 = A[(LU_IND0+0)*1+5-5][b-2][(LU_IND0+0)*1+5-1]-41;

            var_a1 = A[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]+44;
            var_b1 = A[(LU_IND0+1)*1+5-5][b-2][(LU_IND0+1)*1+5-1]-41;
            B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-5]-34;
            A[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+5][b+4][(LU_IND0+1)*1+5+1]-14;
            A[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+3][b+1][(LU_IND0+1)*1+5+2]-8;
            B[(LU_IND0+1)*1+5] = 10;
            var_a1 = A[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]+44;
