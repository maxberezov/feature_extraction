...
/*
 * file for kern_1587749012.340606.c
 */
...
inner:      LU_NUB0 = 24;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         B[LU_IND0*1+4][LU_IND0*1+4][LU_IND0*1+4] = B[LU_IND0*1+4][LU_IND0*1+4][LU_IND0*1+4-4]+39;
         A[LU_IND0*1+4] = A[LU_IND0*1+4+4]+B[LU_IND0*1+4][LU_IND0*1+4][LU_IND0*1+4]-C[LU_IND0*1+4][LU_IND0*1+4][LU_IND0*1+4];
         C[LU_IND0*1+4][LU_IND0*1+4][LU_IND0*1+4] = C[LU_IND0*1+4+4][LU_IND0*1+4+1][LU_IND0*1+4+4]-30;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         B[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = B[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4][(LU_IND0+0)*1+4-4]+39;
         A[(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4+4]+B[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4][(LU_IND0+0)*1+4]-C[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4][(LU_IND0+0)*1+4];
         C[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = C[(LU_IND0+0)*1+4+4][(LU_IND0+0)*1+4+1][(LU_IND0+0)*1+4+4]-30;
         B[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = B[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4][(LU_IND0+1)*1+4-4]+39;
         A[(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4+4]+B[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4][(LU_IND0+1)*1+4]-C[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4][(LU_IND0+1)*1+4];
         C[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = C[(LU_IND0+1)*1+4+4][(LU_IND0+1)*1+4+1][(LU_IND0+1)*1+4+4]-30;
l99998:         ;
      }
      a = 4+MAX0(LU_NUB0, 0)*1;
   }
