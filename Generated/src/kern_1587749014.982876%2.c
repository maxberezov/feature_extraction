...
/*
 * file for kern_1587749014.982876.c
 */
...
inner:      LU_NUB0 = 123;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         A[LU_IND0*1+5] = A[LU_IND0*1+5-3]*45;
         A[LU_IND0*1+5] = A[LU_IND0*1+5-4]-9;
         B[LU_IND0*1+5] = B[LU_IND0*1+5-2]-34;
         C[LU_IND0*1+5][LU_IND0*1+5] = C[LU_IND0*1+5-2][LU_IND0*1+5-5]*16;
         B[LU_IND0*1+5] = B[LU_IND0*1+5+3]-45;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-3]*45;
         A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-4]-9;
         B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-2]-34;
         C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5-2][(LU_IND0+0)*1+5-5]*16;
         B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5+3]-45;
         A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-3]*45;
         A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-4]-9;
         B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-2]-34;
         C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5-2][(LU_IND0+1)*1+5-5]*16;
         B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5+3]-45;
l99998:         ;
      }
