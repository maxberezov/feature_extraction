...
/*
 * file for kern_1587749001.918364.c
 */
...
inner:               LU_NUB0 = 56;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  var_a0 = A[LU_IND0*1+3][b][c]*6;
                  var_b0 = A[LU_IND0*1+3+5][b+3][c+3]-5;
                  A[LU_IND0*1+3][b][c] = A[LU_IND0*1+3-3][b-2][c-4]-B[LU_IND0*1+3][b];
                  A[LU_IND0*1+3][b][c] = 13;
                  var_a0 = A[LU_IND0*1+3][b][c]*6;
...
l99999:                  ;
               ...
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  var_a2 = A[(LU_IND0+0)*1+3][b][c]*6;
                  var_b2 = A[(LU_IND0+0)*1+3+5][b+3][c+3]-5;
                  A[(LU_IND0+0)*1+3][b][c] = A[(LU_IND0+0)*1+3-3][b-2][c-4]-B[(LU_IND0+0)*1+3][b];
                  A[(LU_IND0+0)*1+3][b][c] = 13;
                  var_a2 = A[(LU_IND0+0)*1+3][b][c]*6;

                  var_b2 = A[(LU_IND0+0)*1+3+5][b+3][c+3]-5;

                  var_a1 = A[(LU_IND0+1)*1+3][b][c]*6;
                  var_b1 = A[(LU_IND0+1)*1+3+5][b+3][c+3]-5;
                  A[(LU_IND0+1)*1+3][b][c] = A[(LU_IND0+1)*1+3-3][b-2][c-4]-B[(LU_IND0+1)*1+3][b];
                  A[(LU_IND0+1)*1+3][b][c] = 13;
                  var_a1 = A[(LU_IND0+1)*1+3][b][c]*6;
