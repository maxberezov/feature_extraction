...
/*
 * file for kern_1587749009.481953.c
 */
...
inner:               LU_NUB0 = 8;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  var_a0 = C[LU_IND0*1+5][b][c]-8;
                  var_b0 = C[LU_IND0*1+5-5][b-1][c-4]+4;
                  B[LU_IND0*1+5] = B[LU_IND0*1+5-5]+A[LU_IND0*1+5][b][c];
                  B[LU_IND0*1+5] = B[LU_IND0*1+5-4]-50*A[LU_IND0*1+5][b][c];
                  C[LU_IND0*1+5][b][c] = C[LU_IND0*1+5][b+5][c]*15;
                  C[LU_IND0*1+5][b][c] = B[LU_IND0*1+5];
                  A[LU_IND0*1+5][b][c] = A[LU_IND0*1+5][b][c]-24;
                  B[LU_IND0*1+5] = A[LU_IND0*1+5-3][b-2][c]-C[LU_IND0*1+5][b][c];
                  var_a0 = C[LU_IND0*1+5][b][c]-8;
...
l99999:                  ;
               ...
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  var_a2 = C[(LU_IND0+0)*1+5][b][c]-8;
                  var_b2 = C[(LU_IND0+0)*1+5-5][b-1][c-4]+4;
                  B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-5]+A[(LU_IND0+0)*1+5][b][c];
                  B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-4]-50*A[(LU_IND0+0)*1+5][b][c];
                  C[(LU_IND0+0)*1+5][b][c] = C[(LU_IND0+0)*1+5][b+5][c]*15;
                  C[(LU_IND0+0)*1+5][b][c] = B[(LU_IND0+0)*1+5];
                  A[(LU_IND0+0)*1+5][b][c] = A[(LU_IND0+0)*1+5][b][c]-24;
                  B[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-3][b-2][c]-C[(LU_IND0+0)*1+5][b][c];
                  var_a2 = C[(LU_IND0+0)*1+5][b][c]-8;

                  var_b2 = C[(LU_IND0+0)*1+5-5][b-1][c-4]+4;

                  var_a1 = C[(LU_IND0+1)*1+5][b][c]-8;
                  var_b1 = C[(LU_IND0+1)*1+5-5][b-1][c-4]+4;
                  B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-5]+A[(LU_IND0+1)*1+5][b][c];
                  B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-4]-50*A[(LU_IND0+1)*1+5][b][c];
                  C[(LU_IND0+1)*1+5][b][c] = C[(LU_IND0+1)*1+5][b+5][c]*15;
                  C[(LU_IND0+1)*1+5][b][c] = B[(LU_IND0+1)*1+5];
                  A[(LU_IND0+1)*1+5][b][c] = A[(LU_IND0+1)*1+5][b][c]-24;
                  B[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-3][b-2][c]-C[(LU_IND0+1)*1+5][b][c];
                  var_a1 = C[(LU_IND0+1)*1+5][b][c]-8;
