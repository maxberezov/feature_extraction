...
/*
 * file for kern_1587749013.585037.c
 */
...
inner:            LU_NUB0 = 59;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               B[LU_IND0*1+2] = B[LU_IND0*1+2+3]-A[LU_IND0*1+2][b][c];
               B[LU_IND0*1+2] = B[LU_IND0*1+2+4]*A[LU_IND0*1+2][b][c];
               A[LU_IND0*1+2][b][c] = A[LU_IND0*1+2+3][b+3][c+5]-B[LU_IND0*1+2];
               A[LU_IND0*1+2][b][c] = 49;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+3]-A[(LU_IND0+0)*1+2][b][c];
               B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+4]*A[(LU_IND0+0)*1+2][b][c];
               A[(LU_IND0+0)*1+2][b][c] = A[(LU_IND0+0)*1+2+3][b+3][c+5]-B[(LU_IND0+0)*1+2];
               A[(LU_IND0+0)*1+2][b][c] = 49;
               B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+3]-A[(LU_IND0+1)*1+2][b][c];
               B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+4]*A[(LU_IND0+1)*1+2][b][c];
               A[(LU_IND0+1)*1+2][b][c] = A[(LU_IND0+1)*1+2+3][b+3][c+5]-B[(LU_IND0+1)*1+2];
               A[(LU_IND0+1)*1+2][b][c] = 49;
l99998:               ;
            }
