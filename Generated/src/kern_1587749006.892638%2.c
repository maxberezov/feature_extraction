...
/*
 * file for kern_1587749006.892638.c
 */
...
inner:      LU_NUB0 = 250;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+1][LU_IND0*1+1]-34;
         var_b0 = A[LU_IND0*1+1-1][LU_IND0*1+1-1]+29;
         A[LU_IND0*1+1][LU_IND0*1+1] = A[LU_IND0*1+1+5][LU_IND0*1+1+5]-25;
         var_a0 = A[LU_IND0*1+1][LU_IND0*1+1]-34;
...
l99999:         ;
      ...
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+1][(LU_IND0+0)*1+1]-34;
         var_b2 = A[(LU_IND0+0)*1+1-1][(LU_IND0+0)*1+1-1]+29;
         A[(LU_IND0+0)*1+1][(LU_IND0+0)*1+1] = A[(LU_IND0+0)*1+1+5][(LU_IND0+0)*1+1+5]-25;
         var_a2 = A[(LU_IND0+0)*1+1][(LU_IND0+0)*1+1]-34;

         var_b2 = A[(LU_IND0+0)*1+1-1][(LU_IND0+0)*1+1-1]+29;

         var_a1 = A[(LU_IND0+1)*1+1][(LU_IND0+1)*1+1]-34;
         var_b1 = A[(LU_IND0+1)*1+1-1][(LU_IND0+1)*1+1-1]+29;
         A[(LU_IND0+1)*1+1][(LU_IND0+1)*1+1] = A[(LU_IND0+1)*1+1+5][(LU_IND0+1)*1+1+5]-25;
         var_a1 = A[(LU_IND0+1)*1+1][(LU_IND0+1)*1+1]-34;
