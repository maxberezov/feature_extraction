...
/*
 * file for kern_1587749010.176488.c
 */
...
int main(int argc, const char *argv[])
{
   ...
   clock_t start = clock();
   {
      ...
      for(b = 1; b <= 131071; b += 1) {
         int a;
inner:         LU_NUB0 = 131071;
         LU_IB0 = 1;
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = A[LU_IND0*1+1]-9;
            var_b0 = A[LU_IND0*1+1-1]-17;
            var_a0 = A[LU_IND0*1+1]-9;
...
l99999:            ;
         ...
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = A[(LU_IND0+0)*1+1]-9;
            var_b2 = A[(LU_IND0+0)*1+1-1]-17;
            var_a2 = A[(LU_IND0+0)*1+1]-9;

            var_b2 = A[(LU_IND0+0)*1+1-1]-17;

            var_a1 = A[(LU_IND0+1)*1+1]-9;
            var_b1 = A[(LU_IND0+1)*1+1-1]-17;
            var_a1 = A[(LU_IND0+1)*1+1]-9;
