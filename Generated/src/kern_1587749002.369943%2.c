...
/*
 * file for kern_1587749002.369943.c
 */
...
inner:            LU_NUB0 = 119;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               A[LU_IND0*1+5][b] = A[LU_IND0*1+5+1][b+2]-27;
               A[LU_IND0*1+5][b] = 7;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               A[(LU_IND0+0)*1+5][b] = A[(LU_IND0+0)*1+5+1][b+2]-27;
               A[(LU_IND0+0)*1+5][b] = 7;
               A[(LU_IND0+1)*1+5][b] = A[(LU_IND0+1)*1+5+1][b+2]-27;
               A[(LU_IND0+1)*1+5][b] = 7;
l99998:               ;
            }
