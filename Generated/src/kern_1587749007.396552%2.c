...
/*
 * file for kern_1587749007.396552.c
 */
...
inner:         LU_NUB0 = 65534;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            B[LU_IND0*1+2] = B[LU_IND0*1+2+3]-C[LU_IND0*1+2];
            B[LU_IND0*1+2] = 37;
            C[LU_IND0*1+2] = A[LU_IND0*1+2]-B[LU_IND0*1+2];
            B[LU_IND0*1+2] = A[LU_IND0*1+2-2]*B[LU_IND0*1+2]-C[LU_IND0*1+2];
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+3]-C[(LU_IND0+0)*1+2];
            B[(LU_IND0+0)*1+2] = 37;
            C[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2]-B[(LU_IND0+0)*1+2];
            B[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2-2]*B[(LU_IND0+0)*1+2]-C[(LU_IND0+0)*1+2];
            B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+3]-C[(LU_IND0+1)*1+2];
            B[(LU_IND0+1)*1+2] = 37;
            C[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2]-B[(LU_IND0+1)*1+2];
            B[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2-2]*B[(LU_IND0+1)*1+2]-C[(LU_IND0+1)*1+2];
l99998:            ;
         }
