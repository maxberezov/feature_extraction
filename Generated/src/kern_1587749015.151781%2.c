...
/*
 * file for kern_1587749015.151781.c
 */
...
inner:            LU_NUB0 = 57;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               B[LU_IND0*1+5][b] = B[LU_IND0*1+5-4][b-3]*2;
               A[LU_IND0*1+5][b][c] = B[LU_IND0*1+5][b];
               A[LU_IND0*1+5-5][b-2][c-2] = B[LU_IND0*1+5][b];
               A[LU_IND0*1+5][b][c] = B[LU_IND0*1+5][b];
               A[LU_IND0*1+5][b][c] = B[LU_IND0*1+5][b]*A[LU_IND0*1+5][b][c];
               B[LU_IND0*1+5][b] = B[LU_IND0*1+5-3][b-1]+1;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               B[(LU_IND0+0)*1+5][b] = B[(LU_IND0+0)*1+5-4][b-3]*2;
               A[(LU_IND0+0)*1+5][b][c] = B[(LU_IND0+0)*1+5][b];
               A[(LU_IND0+0)*1+5-5][b-2][c-2] = B[(LU_IND0+0)*1+5][b];
               A[(LU_IND0+0)*1+5][b][c] = B[(LU_IND0+0)*1+5][b];
               A[(LU_IND0+0)*1+5][b][c] = B[(LU_IND0+0)*1+5][b]*A[(LU_IND0+0)*1+5][b][c];
               B[(LU_IND0+0)*1+5][b] = B[(LU_IND0+0)*1+5-3][b-1]+1;
               B[(LU_IND0+1)*1+5][b] = B[(LU_IND0+1)*1+5-4][b-3]*2;
               A[(LU_IND0+1)*1+5][b][c] = B[(LU_IND0+1)*1+5][b];
               A[(LU_IND0+1)*1+5-5][b-2][c-2] = B[(LU_IND0+1)*1+5][b];
               A[(LU_IND0+1)*1+5][b][c] = B[(LU_IND0+1)*1+5][b];
               A[(LU_IND0+1)*1+5][b][c] = B[(LU_IND0+1)*1+5][b]*A[(LU_IND0+1)*1+5][b][c];
               B[(LU_IND0+1)*1+5][b] = B[(LU_IND0+1)*1+5-3][b-1]+1;
l99998:               ;
            }
