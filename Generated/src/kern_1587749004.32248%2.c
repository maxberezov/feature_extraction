...
/*
 * file for kern_1587749004.32248.c
 */
...
inner:               LU_NUB0 = 510;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+0][b] = B[LU_IND0*1+0+2][b+2]*29;
                  B[LU_IND0*1+0][b] = 9;
                  A[LU_IND0*1+0][b][c] = B[LU_IND0*1+0][b]*5;
                  B[LU_IND0*1+0][b] = B[LU_IND0*1+0][b+5]*A[LU_IND0*1+0][b][c];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+0][b] = B[(LU_IND0+0)*1+0+2][b+2]*29;
                  B[(LU_IND0+0)*1+0][b] = 9;
                  A[(LU_IND0+0)*1+0][b][c] = B[(LU_IND0+0)*1+0][b]*5;
                  B[(LU_IND0+0)*1+0][b] = B[(LU_IND0+0)*1+0][b+5]*A[(LU_IND0+0)*1+0][b][c];
                  B[(LU_IND0+1)*1+0][b] = B[(LU_IND0+1)*1+0+2][b+2]*29;
                  B[(LU_IND0+1)*1+0][b] = 9;
                  A[(LU_IND0+1)*1+0][b][c] = B[(LU_IND0+1)*1+0][b]*5;
                  B[(LU_IND0+1)*1+0][b] = B[(LU_IND0+1)*1+0][b+5]*A[(LU_IND0+1)*1+0][b][c];
l99998:                  ;
               }
