...
/*
 * file for kern_1587749006.722991.c
 */
...
inner:            LU_NUB0 = 507;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               C[LU_IND0*1+5] = B[LU_IND0*1+5][b]-A[LU_IND0*1+5][b];
               A[LU_IND0*1+5][b] = B[LU_IND0*1+5-5][b]+C[LU_IND0*1+5]*28;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               C[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5][b]-A[(LU_IND0+0)*1+5][b];
               A[(LU_IND0+0)*1+5][b] = B[(LU_IND0+0)*1+5-5][b]+C[(LU_IND0+0)*1+5]*28;
               C[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5][b]-A[(LU_IND0+1)*1+5][b];
               A[(LU_IND0+1)*1+5][b] = B[(LU_IND0+1)*1+5-5][b]+C[(LU_IND0+1)*1+5]*28;
l99998:               ;
            }
