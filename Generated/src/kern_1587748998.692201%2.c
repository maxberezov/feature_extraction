...
/*
 * file for kern_1587748998.692201.c
 */
...
inner:      LU_NUB0 = 123;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         B[LU_IND0*1+0][LU_IND0*1+0] = 13;
         B[LU_IND0*1+0][LU_IND0*1+0+5] = 44;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         B[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0] = 13;
         B[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0+5] = 44;
         B[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0] = 13;
         B[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0+5] = 44;
l99998:         ;
      }
