...
/*
 * file for kern_1587749007.896029.c
 */
...
inner:               LU_NUB0 = 508;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  C[LU_IND0*1+0] = C[LU_IND0*1+0+2]+46;
                  E[LU_IND0*1+0][b] = E[LU_IND0*1+0+4][b+5]+C[LU_IND0*1+0]-A[LU_IND0*1+0][b]*D[LU_IND0*1+0][b][c];
                  D[LU_IND0*1+0][b][c] = C[LU_IND0*1+0]+E[LU_IND0*1+0][b]*B[LU_IND0*1+0][b]-E[LU_IND0*1+0][b]-A[LU_IND0*1+0][b];
                  B[LU_IND0*1+0][b] = C[LU_IND0*1+0+3]-E[LU_IND0*1+0][b]*D[LU_IND0*1+0][b][c];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  C[(LU_IND0+0)*1+0] = C[(LU_IND0+0)*1+0+2]+46;
                  E[(LU_IND0+0)*1+0][b] = E[(LU_IND0+0)*1+0+4][b+5]+C[(LU_IND0+0)*1+0]-A[(LU_IND0+0)*1+0][b]*D[(LU_IND0+0)*1+0][b][c];
                  D[(LU_IND0+0)*1+0][b][c] = C[(LU_IND0+0)*1+0]+E[(LU_IND0+0)*1+0][b]*B[(LU_IND0+0)*1+0][b]-E[(LU_IND0+0)*1+0][b]-A[(LU_IND0+0)*1+0][b];
                  B[(LU_IND0+0)*1+0][b] = C[(LU_IND0+0)*1+0+3]-E[(LU_IND0+0)*1+0][b]*D[(LU_IND0+0)*1+0][b][c];
                  C[(LU_IND0+1)*1+0] = C[(LU_IND0+1)*1+0+2]+46;
                  E[(LU_IND0+1)*1+0][b] = E[(LU_IND0+1)*1+0+4][b+5]+C[(LU_IND0+1)*1+0]-A[(LU_IND0+1)*1+0][b]*D[(LU_IND0+1)*1+0][b][c];
                  D[(LU_IND0+1)*1+0][b][c] = C[(LU_IND0+1)*1+0]+E[(LU_IND0+1)*1+0][b]*B[(LU_IND0+1)*1+0][b]-E[(LU_IND0+1)*1+0][b]-A[(LU_IND0+1)*1+0][b];
                  B[(LU_IND0+1)*1+0][b] = C[(LU_IND0+1)*1+0+3]-E[(LU_IND0+1)*1+0][b]*D[(LU_IND0+1)*1+0][b][c];
l99998:                  ;
               }
