...
/*
 * file for kern_1587749003.904691.c
 */
...
inner:            LU_NUB0 = 60;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               var_a0 = B[LU_IND0*1+2][b][c]-5;
               var_b0 = B[LU_IND0*1+2+2][b+2][c]+10;
               E[LU_IND0*1+2][b][c] = E[LU_IND0*1+2-2][b-1][c-3]+32;
               var_a0 = B[LU_IND0*1+2][b][c]-5;
...
l99999:               ;
            ...
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               var_a2 = B[(LU_IND0+0)*1+2][b][c]-5;
               var_b2 = B[(LU_IND0+0)*1+2+2][b+2][c]+10;
               E[(LU_IND0+0)*1+2][b][c] = E[(LU_IND0+0)*1+2-2][b-1][c-3]+32;
               var_a2 = B[(LU_IND0+0)*1+2][b][c]-5;

               var_b2 = B[(LU_IND0+0)*1+2+2][b+2][c]+10;

               var_a1 = B[(LU_IND0+1)*1+2][b][c]-5;
               var_b1 = B[(LU_IND0+1)*1+2+2][b+2][c]+10;
               E[(LU_IND0+1)*1+2][b][c] = E[(LU_IND0+1)*1+2-2][b-1][c-3]+32;
               var_a1 = B[(LU_IND0+1)*1+2][b][c]-5;
