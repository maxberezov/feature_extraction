...
/*
 * file for kern_1587749003.472841.c
 */
...
inner:            LU_NUB0 = 508;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               var_a0 = A[LU_IND0*1+4][b]*30;
               var_b0 = A[LU_IND0*1+4-4][b-5]+18;
               var_c0 = A[LU_IND0*1+4][b]*48;
               var_d0 = A[LU_IND0*1+4][b-3]*35;
               A[LU_IND0*1+4][b] = A[LU_IND0*1+4][b+4]*19;
               var_a0 = A[LU_IND0*1+4][b]*30;
...
l99999:               ;
            ...
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               var_a2 = A[(LU_IND0+0)*1+4][b]*30;
               var_b2 = A[(LU_IND0+0)*1+4-4][b-5]+18;
               var_c2 = A[(LU_IND0+0)*1+4][b]*48;
               var_d2 = A[(LU_IND0+0)*1+4][b-3]*35;
               A[(LU_IND0+0)*1+4][b] = A[(LU_IND0+0)*1+4][b+4]*19;
               var_a2 = A[(LU_IND0+0)*1+4][b]*30;
               ...
               var_a1 = A[(LU_IND0+1)*1+4][b]*30;
               var_b1 = A[(LU_IND0+1)*1+4-4][b-5]+18;
               var_c1 = A[(LU_IND0+1)*1+4][b]*48;
               var_d1 = A[(LU_IND0+1)*1+4][b-3]*35;
               A[(LU_IND0+1)*1+4][b] = A[(LU_IND0+1)*1+4][b+4]*19;
               var_a1 = A[(LU_IND0+1)*1+4][b]*30;
