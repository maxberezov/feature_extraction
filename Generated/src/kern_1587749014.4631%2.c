...
/*
 * file for kern_1587749014.4631.c
 */
...
inner:               LU_NUB0 = 250;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+4][b] = B[LU_IND0*1+4-3][b]*42;
                  C[LU_IND0*1+4][b] = C[LU_IND0*1+4-2][b-3]-18;
                  C[LU_IND0*1+4][b] = C[LU_IND0*1+4+2][b+2]+B[LU_IND0*1+4][b]*A[LU_IND0*1+4][b];
                  B[LU_IND0*1+4][b] = 24;
                  A[LU_IND0*1+4][b] = C[LU_IND0*1+4][b]+9*B[LU_IND0*1+4][b];
                  B[LU_IND0*1+4][b] = C[LU_IND0*1+4-4][b-3]-A[LU_IND0*1+4][b]*B[LU_IND0*1+4][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+4][b] = B[(LU_IND0+0)*1+4-3][b]*42;
                  C[(LU_IND0+0)*1+4][b] = C[(LU_IND0+0)*1+4-2][b-3]-18;
                  C[(LU_IND0+0)*1+4][b] = C[(LU_IND0+0)*1+4+2][b+2]+B[(LU_IND0+0)*1+4][b]*A[(LU_IND0+0)*1+4][b];
                  B[(LU_IND0+0)*1+4][b] = 24;
                  A[(LU_IND0+0)*1+4][b] = C[(LU_IND0+0)*1+4][b]+9*B[(LU_IND0+0)*1+4][b];
                  B[(LU_IND0+0)*1+4][b] = C[(LU_IND0+0)*1+4-4][b-3]-A[(LU_IND0+0)*1+4][b]*B[(LU_IND0+0)*1+4][b];
                  B[(LU_IND0+1)*1+4][b] = B[(LU_IND0+1)*1+4-3][b]*42;
                  C[(LU_IND0+1)*1+4][b] = C[(LU_IND0+1)*1+4-2][b-3]-18;
                  C[(LU_IND0+1)*1+4][b] = C[(LU_IND0+1)*1+4+2][b+2]+B[(LU_IND0+1)*1+4][b]*A[(LU_IND0+1)*1+4][b];
                  B[(LU_IND0+1)*1+4][b] = 24;
                  A[(LU_IND0+1)*1+4][b] = C[(LU_IND0+1)*1+4][b]+9*B[(LU_IND0+1)*1+4][b];
                  B[(LU_IND0+1)*1+4][b] = C[(LU_IND0+1)*1+4-4][b-3]-A[(LU_IND0+1)*1+4][b]*B[(LU_IND0+1)*1+4][b];
l99998:                  ;
               }
