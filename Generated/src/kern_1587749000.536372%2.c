...
/*
 * file for kern_1587749000.536372.c
 */
...
inner:            LU_NUB0 = 59;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               var_a0 = A[LU_IND0*1+5]+8;
               var_b0 = A[LU_IND0*1+5-5]-9;
               B[LU_IND0*1+5][b][c] = B[LU_IND0*1+5-5][b-2][c]*41;
               C[LU_IND0*1+5] = C[LU_IND0*1+5+5]+16;
               C[LU_IND0*1+5] = 27;
               B[LU_IND0*1+5][b][c] = 31;
               var_a0 = A[LU_IND0*1+5]+8;
...
l99999:               ;
            ...
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               var_a2 = A[(LU_IND0+0)*1+5]+8;
               var_b2 = A[(LU_IND0+0)*1+5-5]-9;
               B[(LU_IND0+0)*1+5][b][c] = B[(LU_IND0+0)*1+5-5][b-2][c]*41;
               C[(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5+5]+16;
               C[(LU_IND0+0)*1+5] = 27;
               B[(LU_IND0+0)*1+5][b][c] = 31;
               var_a2 = A[(LU_IND0+0)*1+5]+8;

               var_b2 = A[(LU_IND0+0)*1+5-5]-9;

               var_a1 = A[(LU_IND0+1)*1+5]+8;
               var_b1 = A[(LU_IND0+1)*1+5-5]-9;
               B[(LU_IND0+1)*1+5][b][c] = B[(LU_IND0+1)*1+5-5][b-2][c]*41;
               C[(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5+5]+16;
               C[(LU_IND0+1)*1+5] = 27;
               B[(LU_IND0+1)*1+5][b][c] = 31;
               var_a1 = A[(LU_IND0+1)*1+5]+8;
