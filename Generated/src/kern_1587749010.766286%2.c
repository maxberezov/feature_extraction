...
/*
 * file for kern_1587749010.766286.c
 */
...
inner:      LU_NUB0 = 508;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         A[LU_IND0*1+0][LU_IND0*1+0] = 36;
         A[LU_IND0*1+0+4][LU_IND0*1+0+2] = 30;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         A[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0] = 36;
         A[(LU_IND0+0)*1+0+4][(LU_IND0+0)*1+0+2] = 30;
         A[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0] = 36;
         A[(LU_IND0+1)*1+0+4][(LU_IND0+1)*1+0+2] = 30;
l99998:         ;
      }
