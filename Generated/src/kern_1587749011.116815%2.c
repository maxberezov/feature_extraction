...
/*
 * file for kern_1587749011.116815.c
 */
...
inner:         LU_NUB0 = 27;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            A[LU_IND0*1+5][b] = A[LU_IND0*1+5][b+4]+B[LU_IND0*1+5][b];
            C[LU_IND0*1+5][b][LU_IND0*1+5] = A[LU_IND0*1+5][b];
            C[LU_IND0*1+5-4][b-2][LU_IND0*1+5-5] = B[LU_IND0*1+5][b];
            A[LU_IND0*1+5][b] = 44;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            A[(LU_IND0+0)*1+5][b] = A[(LU_IND0+0)*1+5][b+4]+B[(LU_IND0+0)*1+5][b];
            C[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5][b];
            C[(LU_IND0+0)*1+5-4][b-2][(LU_IND0+0)*1+5-5] = B[(LU_IND0+0)*1+5][b];
            A[(LU_IND0+0)*1+5][b] = 44;
            A[(LU_IND0+1)*1+5][b] = A[(LU_IND0+1)*1+5][b+4]+B[(LU_IND0+1)*1+5][b];
            C[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5][b];
            C[(LU_IND0+1)*1+5-4][b-2][(LU_IND0+1)*1+5-5] = B[(LU_IND0+1)*1+5][b];
            A[(LU_IND0+1)*1+5][b] = 44;
l99998:            ;
         }
