...
/*
 * file for kern_1587749008.762926.c
 */
   ...
   clock_t start = clock();
   {
      ...
      for(c = 2; c <= 524282; c += 1) {
         ...
         for(b = 2; b <= 524282; b += 1) {
            int a;
inner:            LU_NUB0 = 524281;
            LU_IB0 = 1;
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               A[LU_IND0*1+2] = 4;
               A[LU_IND0*1+2] = A[LU_IND0*1+2]-B[LU_IND0*1+2];
               A[LU_IND0*1+2] = A[LU_IND0*1+2-2]*B[LU_IND0*1+2];
               A[LU_IND0*1+2] = A[LU_IND0*1+2+3]*B[LU_IND0*1+2];
               B[LU_IND0*1+2] = B[LU_IND0*1+2+5]*34;
               B[LU_IND0*1+2] = B[LU_IND0*1+2+1]*30;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               A[(LU_IND0+0)*1+2] = 4;
               A[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2]-B[(LU_IND0+0)*1+2];
               A[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2-2]*B[(LU_IND0+0)*1+2];
               A[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2+3]*B[(LU_IND0+0)*1+2];
               B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+5]*34;
               B[(LU_IND0+0)*1+2] = B[(LU_IND0+0)*1+2+1]*30;
               A[(LU_IND0+1)*1+2] = 4;
               A[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2]-B[(LU_IND0+1)*1+2];
               A[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2-2]*B[(LU_IND0+1)*1+2];
               A[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2+3]*B[(LU_IND0+1)*1+2];
               B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+5]*34;
               B[(LU_IND0+1)*1+2] = B[(LU_IND0+1)*1+2+1]*30;
l99998:               ;
            }
