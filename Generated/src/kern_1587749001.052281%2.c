...
/*
 * file for kern_1587749001.052281.c
 */
...
inner:            LU_NUB0 = 11;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               var_a0 = B[LU_IND0*1+5][b][c]-33;
               var_b0 = B[LU_IND0*1+5][b-2][c-5]-31;
               A[LU_IND0*1+5] = A[LU_IND0*1+5-2]+30;
               A[LU_IND0*1+5] = A[LU_IND0*1+5+1]*B[LU_IND0*1+5][b][c];
               var_a0 = B[LU_IND0*1+5][b][c]-33;
...
l99999:               ;
            ...
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               var_a2 = B[(LU_IND0+0)*1+5][b][c]-33;
               var_b2 = B[(LU_IND0+0)*1+5][b-2][c-5]-31;
               A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-2]+30;
               A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+1]*B[(LU_IND0+0)*1+5][b][c];
               var_a2 = B[(LU_IND0+0)*1+5][b][c]-33;

               var_b2 = B[(LU_IND0+0)*1+5][b-2][c-5]-31;

               var_a1 = B[(LU_IND0+1)*1+5][b][c]-33;
               var_b1 = B[(LU_IND0+1)*1+5][b-2][c-5]-31;
               A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-2]+30;
               A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+1]*B[(LU_IND0+1)*1+5][b][c];
               var_a1 = B[(LU_IND0+1)*1+5][b][c]-33;
