...
int kern_1587749010176488()
{
   ...
   for(b = 1; b <= 131071; b += 1) {
      int a;
kern_1587749010176488:
      for(a = 1; a <= 131071; a += 1) {
         int var_a = A[a]-9;
         int var_b = A[a-1]-17;
      }
   }
...
int kern_1587749013210712()
{
   ...
   for(b = 1; b <= 262143; b += 1) {
      int a;
kern_1587749013210712:
      for(a = 1; a <= 262143; a += 1)
         A[a] = A[a-1]-37;
   }
...
int kern_1587749009828687()
{
   ...
   for(c = 4; c <= 524287; c += 1) {
      ...
      for(b = 4; b <= 524287; b += 1) {
         int a;
kern_1587749009828687:
         for(a = 4; a <= 524287; a += 1) {
            A[a] = A[a-4]*26;
...
int kern_1587749008762926()
{
   ...
   for(c = 2; c <= 524282; c += 1) {
      ...
      for(b = 2; b <= 524282; b += 1) {
         int a;
kern_1587749008762926:
         for(a = 2; a <= 524282; a += 1) {
            A[a] = 4;
            A[a] = A[a]-B[a];
