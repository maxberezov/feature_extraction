...
/*
 * file for kern_1587749008.235272.c
 */
...
inner:            LU_NUB0 = 61;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               B[LU_IND0*1+3][b][c] = 8+C[LU_IND0*1+3][b];
               B[LU_IND0*1+3-3][b-2][c-1] = A[LU_IND0*1+3][b]*C[LU_IND0*1+3][b];
               A[LU_IND0*1+3][b] = 24;
               A[LU_IND0*1+3+4][b+2] = 28;
               A[LU_IND0*1+3][b] = C[LU_IND0*1+3][b]*6-B[LU_IND0*1+3][b][c];
               C[LU_IND0*1+3][b] = C[LU_IND0*1+3][b-2]+B[LU_IND0*1+3][b][c];
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               B[(LU_IND0+0)*1+3][b][c] = 8+C[(LU_IND0+0)*1+3][b];
               B[(LU_IND0+0)*1+3-3][b-2][c-1] = A[(LU_IND0+0)*1+3][b]*C[(LU_IND0+0)*1+3][b];
               A[(LU_IND0+0)*1+3][b] = 24;
               A[(LU_IND0+0)*1+3+4][b+2] = 28;
               A[(LU_IND0+0)*1+3][b] = C[(LU_IND0+0)*1+3][b]*6-B[(LU_IND0+0)*1+3][b][c];
               C[(LU_IND0+0)*1+3][b] = C[(LU_IND0+0)*1+3][b-2]+B[(LU_IND0+0)*1+3][b][c];
               B[(LU_IND0+1)*1+3][b][c] = 8+C[(LU_IND0+1)*1+3][b];
               B[(LU_IND0+1)*1+3-3][b-2][c-1] = A[(LU_IND0+1)*1+3][b]*C[(LU_IND0+1)*1+3][b];
               A[(LU_IND0+1)*1+3][b] = 24;
               A[(LU_IND0+1)*1+3+4][b+2] = 28;
               A[(LU_IND0+1)*1+3][b] = C[(LU_IND0+1)*1+3][b]*6-B[(LU_IND0+1)*1+3][b][c];
               C[(LU_IND0+1)*1+3][b] = C[(LU_IND0+1)*1+3][b-2]+B[(LU_IND0+1)*1+3][b][c];
l99998:               ;
            }
