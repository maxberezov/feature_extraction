...
/*
 * file for kern_1587749008.067154.c
 */
...
inner:               LU_NUB0 = 504;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  A[LU_IND0*1+5][b] = A[LU_IND0*1+5+3][b+1]*4;
                  A[LU_IND0*1+5][b] = 20;
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  A[(LU_IND0+0)*1+5][b] = A[(LU_IND0+0)*1+5+3][b+1]*4;
                  A[(LU_IND0+0)*1+5][b] = 20;
                  A[(LU_IND0+1)*1+5][b] = A[(LU_IND0+1)*1+5+3][b+1]*4;
                  A[(LU_IND0+1)*1+5][b] = 20;
l99998:                  ;
               }
