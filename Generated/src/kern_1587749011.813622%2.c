...
/*
 * file for kern_1587749011.813622.c
 */
...
inner:               LU_NUB0 = 246;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  C[LU_IND0*1+5][b] = C[LU_IND0*1+5-5][b-3]*30;
                  C[LU_IND0*1+5][b] = 0;
                  B[LU_IND0*1+5][b] = 6;
                  B[LU_IND0*1+5+5][b+3] = A[LU_IND0*1+5][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  C[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5-5][b-3]*30;
                  C[(LU_IND0+0)*1+5][b] = 0;
                  B[(LU_IND0+0)*1+5][b] = 6;
                  B[(LU_IND0+0)*1+5+5][b+3] = A[(LU_IND0+0)*1+5][b];
                  C[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5-5][b-3]*30;
                  C[(LU_IND0+1)*1+5][b] = 0;
                  B[(LU_IND0+1)*1+5][b] = 6;
                  B[(LU_IND0+1)*1+5+5][b+3] = A[(LU_IND0+1)*1+5][b];
l99998:                  ;
               }
