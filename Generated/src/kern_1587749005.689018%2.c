...
/*
 * file for kern_1587749005.689018.c
 */
...
inner:         LU_NUB0 = 248;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            A[LU_IND0*1+3] = A[LU_IND0*1+3+3]+47;
            A[LU_IND0*1+3] = B[LU_IND0*1+3][b]*A[LU_IND0*1+3];
            B[LU_IND0*1+3][b] = A[LU_IND0*1+3];
            B[LU_IND0*1+3][b] = B[LU_IND0*1+3+5][b+3]-48;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            A[(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3+3]+47;
            A[(LU_IND0+0)*1+3] = B[(LU_IND0+0)*1+3][b]*A[(LU_IND0+0)*1+3];
            B[(LU_IND0+0)*1+3][b] = A[(LU_IND0+0)*1+3];
            B[(LU_IND0+0)*1+3][b] = B[(LU_IND0+0)*1+3+5][b+3]-48;
            A[(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3+3]+47;
            A[(LU_IND0+1)*1+3] = B[(LU_IND0+1)*1+3][b]*A[(LU_IND0+1)*1+3];
            B[(LU_IND0+1)*1+3][b] = A[(LU_IND0+1)*1+3];
            B[(LU_IND0+1)*1+3][b] = B[(LU_IND0+1)*1+3+5][b+3]-48;
l99998:            ;
         }
