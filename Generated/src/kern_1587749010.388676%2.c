...
/*
 * file for kern_1587749010.388676.c
 */
...
inner:         LU_NUB0 = 59;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = A[LU_IND0*1+5][b]+8;
            var_b0 = A[LU_IND0*1+5][b+3]-6;
            A[LU_IND0*1+5][b] = A[LU_IND0*1+5+2][b+5]+27;
            B[LU_IND0*1+5][b] = C[LU_IND0*1+5][b][LU_IND0*1+5]-A[LU_IND0*1+5][b];
            B[LU_IND0*1+5+2][b+5] = A[LU_IND0*1+5][b];
            var_a0 = A[LU_IND0*1+5][b]+8;

            var_b0 = A[LU_IND0*1+5][b+3]-6;

            A[LU_IND0*1+5][b] = C[LU_IND0*1+5][b][LU_IND0*1+5]-29;
            B[LU_IND0*1+5][b] = C[LU_IND0*1+5-5][b-4][LU_IND0*1+5-4]*4;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = A[(LU_IND0+0)*1+5][b]+8;
            var_b2 = A[(LU_IND0+0)*1+5][b+3]-6;
            A[(LU_IND0+0)*1+5][b] = A[(LU_IND0+0)*1+5+2][b+5]+27;
            B[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]-A[(LU_IND0+0)*1+5][b];
            B[(LU_IND0+0)*1+5+2][b+5] = A[(LU_IND0+0)*1+5][b];
            var_a2 = A[(LU_IND0+0)*1+5][b]+8;

            var_b2 = A[(LU_IND0+0)*1+5][b+3]-6;

            A[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]-29;
            B[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5-5][b-4][(LU_IND0+0)*1+5-4]*4;
            var_a1 = A[(LU_IND0+1)*1+5][b]+8;
            var_b1 = A[(LU_IND0+1)*1+5][b+3]-6;
            A[(LU_IND0+1)*1+5][b] = A[(LU_IND0+1)*1+5+2][b+5]+27;
            B[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]-A[(LU_IND0+1)*1+5][b];
            B[(LU_IND0+1)*1+5+2][b+5] = A[(LU_IND0+1)*1+5][b];
            var_a1 = A[(LU_IND0+1)*1+5][b]+8;

            var_b1 = A[(LU_IND0+1)*1+5][b+3]-6;

            A[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]-29;
            B[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5-5][b-4][(LU_IND0+1)*1+5-4]*4;
l99998:            ;
         }
