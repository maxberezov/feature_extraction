...
/*
 * file for kern_1587749009.106069.c
 */
...
inner:         LU_NUB0 = 23;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            B[LU_IND0*1+5][b][LU_IND0*1+5] = B[LU_IND0*1+5-4][b-1][LU_IND0*1+5-3]-12;
            A[LU_IND0*1+5][b][LU_IND0*1+5] = A[LU_IND0*1+5+4][b][LU_IND0*1+5+4]+B[LU_IND0*1+5][b][LU_IND0*1+5];
            B[LU_IND0*1+5][b][LU_IND0*1+5] = 50;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-4][b-1][(LU_IND0+0)*1+5-3]-12;
            A[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+4][b][(LU_IND0+0)*1+5+4]+B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5];
            B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = 50;
            B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-4][b-1][(LU_IND0+1)*1+5-3]-12;
            A[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+4][b][(LU_IND0+1)*1+5+4]+B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5];
            B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = 50;
l99998:            ;
         }
