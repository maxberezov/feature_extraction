...
/*
 * file for kern_1587748999.542687.c
 */
...
inner:      LU_NUB0 = 121;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         B[LU_IND0*1+4][LU_IND0*1+4] = 35;
         B[LU_IND0*1+4+3][LU_IND0*1+4+2] = A[LU_IND0*1+4][LU_IND0*1+4];
         B[LU_IND0*1+4][LU_IND0*1+4] = A[LU_IND0*1+4][LU_IND0*1+4];
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         B[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = 35;
         B[(LU_IND0+0)*1+4+3][(LU_IND0+0)*1+4+2] = A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4];
         B[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4];
         B[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = 35;
         B[(LU_IND0+1)*1+4+3][(LU_IND0+1)*1+4+2] = A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4];
         B[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4];
l99998:         ;
      }
