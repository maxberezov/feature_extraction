...
/*
 * file for kern_1587748999.77151.c
 */
...
inner:         LU_NUB0 = 11;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = B[LU_IND0*1+5][b][LU_IND0*1+5]*38;
            var_b0 = B[LU_IND0*1+5-1][b-2][LU_IND0*1+5-3]*49;
            var_c0 = B[LU_IND0*1+5][b][LU_IND0*1+5]*29;
            var_d0 = B[LU_IND0*1+5-1][b-2][LU_IND0*1+5]-7;
            A[LU_IND0*1+5] = A[LU_IND0*1+5-5]*B[LU_IND0*1+5][b][LU_IND0*1+5];
            B[LU_IND0*1+5][b][LU_IND0*1+5] = B[LU_IND0*1+5-5][b-4][LU_IND0*1+5-1]*20;
            A[LU_IND0*1+5] = A[LU_IND0*1+5-1]+35;
            var_a0 = B[LU_IND0*1+5][b][LU_IND0*1+5]*38;
...
l99999:            ;
         ...
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]*38;
            var_b2 = B[(LU_IND0+0)*1+5-1][b-2][(LU_IND0+0)*1+5-3]*49;
            var_c2 = B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]*29;
            var_d2 = B[(LU_IND0+0)*1+5-1][b-2][(LU_IND0+0)*1+5]-7;
            A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-5]*B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5];
            B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-5][b-4][(LU_IND0+0)*1+5-1]*20;
            A[(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-1]+35;
            var_a2 = B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5]*38;
            ...
            var_a1 = B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]*38;
            var_b1 = B[(LU_IND0+1)*1+5-1][b-2][(LU_IND0+1)*1+5-3]*49;
            var_c1 = B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]*29;
            var_d1 = B[(LU_IND0+1)*1+5-1][b-2][(LU_IND0+1)*1+5]-7;
            A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-5]*B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5];
            B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-5][b-4][(LU_IND0+1)*1+5-1]*20;
            A[(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-1]+35;
            var_a1 = B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5]*38;
