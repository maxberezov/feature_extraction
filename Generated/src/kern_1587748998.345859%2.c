...
/*
 * file for kern_1587748998.345859.c
 */
...
inner:         LU_NUB0 = 27;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = A[LU_IND0*1+5][b]*24;
            var_b0 = A[LU_IND0*1+5-2][b-3]-49;
            A[LU_IND0*1+5][b] = A[LU_IND0*1+5+4][b+2]*36;
            C[LU_IND0*1+5][b] = C[LU_IND0*1+5+2][b+1]+35;
            B[LU_IND0*1+5][b][LU_IND0*1+5] = 41;
            B[LU_IND0*1+5][b][LU_IND0*1+5] = 27;
            A[LU_IND0*1+5][b] = 30;
            var_a0 = A[LU_IND0*1+5][b]*24;
...
l99999:            ;
         ...
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = A[(LU_IND0+0)*1+5][b]*24;
            var_b2 = A[(LU_IND0+0)*1+5-2][b-3]-49;
            A[(LU_IND0+0)*1+5][b] = A[(LU_IND0+0)*1+5+4][b+2]*36;
            C[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5+2][b+1]+35;
            B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = 41;
            B[(LU_IND0+0)*1+5][b][(LU_IND0+0)*1+5] = 27;
            A[(LU_IND0+0)*1+5][b] = 30;
            var_a2 = A[(LU_IND0+0)*1+5][b]*24;

            var_b2 = A[(LU_IND0+0)*1+5-2][b-3]-49;

            var_a1 = A[(LU_IND0+1)*1+5][b]*24;
            var_b1 = A[(LU_IND0+1)*1+5-2][b-3]-49;
            A[(LU_IND0+1)*1+5][b] = A[(LU_IND0+1)*1+5+4][b+2]*36;
            C[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5+2][b+1]+35;
            B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = 41;
            B[(LU_IND0+1)*1+5][b][(LU_IND0+1)*1+5] = 27;
            A[(LU_IND0+1)*1+5][b] = 30;
            var_a1 = A[(LU_IND0+1)*1+5][b]*24;
