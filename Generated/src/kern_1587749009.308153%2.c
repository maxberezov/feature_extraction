...
/*
 * file for kern_1587749009.308153.c
 */
...
int main(int argc, const char *argv[])
{
   ...
   int LU_NUB0, LU_IB0, LU_IND0, var_a0, var_a1, var_a2;
   srand(time((void *) 0));
...
inner:         LU_NUB0 = 509;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = C[LU_IND0*1+0]-29;
            B[LU_IND0*1+0][b] = B[LU_IND0*1+0+3][b+2]-42;
            var_a0 = C[LU_IND0*1+0]-29;
...
l99999:            ;
         ...
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = C[(LU_IND0+0)*1+0]-29;
            B[(LU_IND0+0)*1+0][b] = B[(LU_IND0+0)*1+0+3][b+2]-42;
            var_a2 = C[(LU_IND0+0)*1+0]-29;

            C[(LU_IND0+0)*1+0] = 31;
            var_a1 = C[(LU_IND0+1)*1+0]-29;
            B[(LU_IND0+1)*1+0][b] = B[(LU_IND0+1)*1+0+3][b+2]-42;
            var_a1 = C[(LU_IND0+1)*1+0]-29;
