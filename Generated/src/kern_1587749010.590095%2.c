...
/*
 * file for kern_1587749010.590095.c
 */
...
inner:               LU_NUB0 = 251;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+5] = B[LU_IND0*1+5-3]+18;
                  B[LU_IND0*1+5] = B[LU_IND0*1+5+5]*C[LU_IND0*1+5][b]-3;
                  C[LU_IND0*1+5][b] = B[LU_IND0*1+5];
                  C[LU_IND0*1+5-4][b-3] = 8;
                  C[LU_IND0*1+5][b] = C[LU_IND0*1+5][b]*A[LU_IND0*1+5][b];
                  B[LU_IND0*1+5] = C[LU_IND0*1+5-5][b-5]*B[LU_IND0*1+5]+A[LU_IND0*1+5][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-3]+18;
                  B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5+5]*C[(LU_IND0+0)*1+5][b]-3;
                  C[(LU_IND0+0)*1+5][b] = B[(LU_IND0+0)*1+5];
                  C[(LU_IND0+0)*1+5-4][b-3] = 8;
                  C[(LU_IND0+0)*1+5][b] = C[(LU_IND0+0)*1+5][b]*A[(LU_IND0+0)*1+5][b];
                  B[(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5-5][b-5]*B[(LU_IND0+0)*1+5]+A[(LU_IND0+0)*1+5][b];
                  B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-3]+18;
                  B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5+5]*C[(LU_IND0+1)*1+5][b]-3;
                  C[(LU_IND0+1)*1+5][b] = B[(LU_IND0+1)*1+5];
                  C[(LU_IND0+1)*1+5-4][b-3] = 8;
                  C[(LU_IND0+1)*1+5][b] = C[(LU_IND0+1)*1+5][b]*A[(LU_IND0+1)*1+5][b];
                  B[(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5-5][b-5]*B[(LU_IND0+1)*1+5]+A[(LU_IND0+1)*1+5][b];
l99998:                  ;
               }
