...
/*
 * file for kern_1587749006.554335.c
 */
...
inner:               LU_NUB0 = 11;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  A[LU_IND0*1+5][b][c] = A[LU_IND0*1+5][b][c-1]+26;
                  B[LU_IND0*1+5][b] = B[LU_IND0*1+5+5][b]+C[LU_IND0*1+5][b][c];
                  C[LU_IND0*1+5][b][c] = 24;
                  C[LU_IND0*1+5-4][b-5][c-3] = 23;
                  C[LU_IND0*1+5][b][c] = 36;
                  C[LU_IND0*1+5][b][c] = A[LU_IND0*1+5][b][c]-B[LU_IND0*1+5][b]*C[LU_IND0*1+5][b][c];
                  A[LU_IND0*1+5][b][c] = A[LU_IND0*1+5-1][b-4][c-1]-C[LU_IND0*1+5][b][c]+B[LU_IND0*1+5][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  A[(LU_IND0+0)*1+5][b][c] = A[(LU_IND0+0)*1+5][b][c-1]+26;
                  B[(LU_IND0+0)*1+5][b] = B[(LU_IND0+0)*1+5+5][b]+C[(LU_IND0+0)*1+5][b][c];
                  C[(LU_IND0+0)*1+5][b][c] = 24;
                  C[(LU_IND0+0)*1+5-4][b-5][c-3] = 23;
                  C[(LU_IND0+0)*1+5][b][c] = 36;
                  C[(LU_IND0+0)*1+5][b][c] = A[(LU_IND0+0)*1+5][b][c]-B[(LU_IND0+0)*1+5][b]*C[(LU_IND0+0)*1+5][b][c];
                  A[(LU_IND0+0)*1+5][b][c] = A[(LU_IND0+0)*1+5-1][b-4][c-1]-C[(LU_IND0+0)*1+5][b][c]+B[(LU_IND0+0)*1+5][b];
                  A[(LU_IND0+1)*1+5][b][c] = A[(LU_IND0+1)*1+5][b][c-1]+26;
                  B[(LU_IND0+1)*1+5][b] = B[(LU_IND0+1)*1+5+5][b]+C[(LU_IND0+1)*1+5][b][c];
                  C[(LU_IND0+1)*1+5][b][c] = 24;
                  C[(LU_IND0+1)*1+5-4][b-5][c-3] = 23;
                  C[(LU_IND0+1)*1+5][b][c] = 36;
                  C[(LU_IND0+1)*1+5][b][c] = A[(LU_IND0+1)*1+5][b][c]-B[(LU_IND0+1)*1+5][b]*C[(LU_IND0+1)*1+5][b][c];
                  A[(LU_IND0+1)*1+5][b][c] = A[(LU_IND0+1)*1+5-1][b-4][c-1]-C[(LU_IND0+1)*1+5][b][c]+B[(LU_IND0+1)*1+5][b];
l99998:                  ;
               }
