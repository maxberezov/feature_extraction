...
/*
 * file for kern_1587749007.729511.c
 */
...
inner:      LU_NUB0 = 249;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         B[LU_IND0*1+4] = B[LU_IND0*1+4-4]+44;
         A[LU_IND0*1+4][LU_IND0*1+4] = 17;
         A[LU_IND0*1+4][LU_IND0*1+4+3] = 38;
         B[LU_IND0*1+4] = B[LU_IND0*1+4]+A[LU_IND0*1+4][LU_IND0*1+4];
         A[LU_IND0*1+4][LU_IND0*1+4] = B[LU_IND0*1+4+5]*A[LU_IND0*1+4][LU_IND0*1+4];
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         B[(LU_IND0+0)*1+4] = B[(LU_IND0+0)*1+4-4]+44;
         A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = 17;
         A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4+3] = 38;
         B[(LU_IND0+0)*1+4] = B[(LU_IND0+0)*1+4]+A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4];
         A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4] = B[(LU_IND0+0)*1+4+5]*A[(LU_IND0+0)*1+4][(LU_IND0+0)*1+4];
         B[(LU_IND0+1)*1+4] = B[(LU_IND0+1)*1+4-4]+44;
         A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = 17;
         A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4+3] = 38;
         B[(LU_IND0+1)*1+4] = B[(LU_IND0+1)*1+4]+A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4];
         A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4] = B[(LU_IND0+1)*1+4+5]*A[(LU_IND0+1)*1+4][(LU_IND0+1)*1+4];
l99998:         ;
      }
