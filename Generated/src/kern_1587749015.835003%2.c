...
/*
 * file for kern_1587749015.835003.c
 */
...
inner:            LU_NUB0 = 8;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               E[LU_IND0*1+3] = E[LU_IND0*1+3-3]*C[LU_IND0*1+3][b][c]-B[LU_IND0*1+3][b]+D[LU_IND0*1+3][b];
               B[LU_IND0*1+3][b] = B[LU_IND0*1+3-1][b-3]+42;
               C[LU_IND0*1+3][b][c] = C[LU_IND0*1+3+5][b+2][c+2]*28;
               E[LU_IND0*1+3] = A[LU_IND0*1+3]+B[LU_IND0*1+3][b]-27-A[LU_IND0*1+3];
               E[LU_IND0*1+3] = E[LU_IND0*1+3]*D[LU_IND0*1+3][b];
               C[LU_IND0*1+3][b][c] = E[LU_IND0*1+3+5]+A[LU_IND0*1+3]*B[LU_IND0*1+3][b]-8;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               E[(LU_IND0+0)*1+3] = E[(LU_IND0+0)*1+3-3]*C[(LU_IND0+0)*1+3][b][c]-B[(LU_IND0+0)*1+3][b]+D[(LU_IND0+0)*1+3][b];
               B[(LU_IND0+0)*1+3][b] = B[(LU_IND0+0)*1+3-1][b-3]+42;
               C[(LU_IND0+0)*1+3][b][c] = C[(LU_IND0+0)*1+3+5][b+2][c+2]*28;
               E[(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3]+B[(LU_IND0+0)*1+3][b]-27-A[(LU_IND0+0)*1+3];
               E[(LU_IND0+0)*1+3] = E[(LU_IND0+0)*1+3]*D[(LU_IND0+0)*1+3][b];
               C[(LU_IND0+0)*1+3][b][c] = E[(LU_IND0+0)*1+3+5]+A[(LU_IND0+0)*1+3]*B[(LU_IND0+0)*1+3][b]-8;
               E[(LU_IND0+1)*1+3] = E[(LU_IND0+1)*1+3-3]*C[(LU_IND0+1)*1+3][b][c]-B[(LU_IND0+1)*1+3][b]+D[(LU_IND0+1)*1+3][b];
               B[(LU_IND0+1)*1+3][b] = B[(LU_IND0+1)*1+3-1][b-3]+42;
               C[(LU_IND0+1)*1+3][b][c] = C[(LU_IND0+1)*1+3+5][b+2][c+2]*28;
               E[(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3]+B[(LU_IND0+1)*1+3][b]-27-A[(LU_IND0+1)*1+3];
               E[(LU_IND0+1)*1+3] = E[(LU_IND0+1)*1+3]*D[(LU_IND0+1)*1+3][b];
               C[(LU_IND0+1)*1+3][b][c] = E[(LU_IND0+1)*1+3+5]+A[(LU_IND0+1)*1+3]*B[(LU_IND0+1)*1+3][b]-8;
l99998:               ;
            }
            a = 3+MAX0(LU_NUB0, 0)*1;
         }
      }
   }
