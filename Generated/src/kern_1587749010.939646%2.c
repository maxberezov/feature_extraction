...
/*
 * file for kern_1587749010.939646.c
 */
...
inner:            LU_NUB0 = 24;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               A[LU_IND0*1+3][b][c] = A[LU_IND0*1+3-3][b-1][c-4]+25;
               B[LU_IND0*1+3][b][c] = B[LU_IND0*1+3+5][b+1][c+1]-21;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               A[(LU_IND0+0)*1+3][b][c] = A[(LU_IND0+0)*1+3-3][b-1][c-4]+25;
               B[(LU_IND0+0)*1+3][b][c] = B[(LU_IND0+0)*1+3+5][b+1][c+1]-21;
               A[(LU_IND0+1)*1+3][b][c] = A[(LU_IND0+1)*1+3-3][b-1][c-4]+25;
               B[(LU_IND0+1)*1+3][b][c] = B[(LU_IND0+1)*1+3+5][b+1][c+1]-21;
l99998:               ;
            }
