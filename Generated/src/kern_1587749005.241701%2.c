...
/*
 * file for kern_1587749005.241701.c
 */
...
inner:      LU_NUB0 = 27;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+0]-10;
         var_b0 = A[LU_IND0*1+0]+6;
         B[LU_IND0*1+0][LU_IND0*1+0][LU_IND0*1+0] = B[LU_IND0*1+0+4][LU_IND0*1+0+5][LU_IND0*1+0+4]+17;
         var_a0 = A[LU_IND0*1+0]-10;
...
l99999:         ;
      ...
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+0]-10;
         var_b2 = A[(LU_IND0+0)*1+0]+6;
         B[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0][(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0+4][(LU_IND0+0)*1+0+5][(LU_IND0+0)*1+0+4]+17;
         var_a2 = A[(LU_IND0+0)*1+0]-10;

         var_b2 = A[(LU_IND0+0)*1+0]+6;

         var_a1 = A[(LU_IND0+1)*1+0]-10;
         var_b1 = A[(LU_IND0+1)*1+0]+6;
         B[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0][(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0+4][(LU_IND0+1)*1+0+5][(LU_IND0+1)*1+0+4]+17;
         var_a1 = A[(LU_IND0+1)*1+0]-10;
