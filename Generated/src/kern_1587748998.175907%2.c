...
/*
 * file for kern_1587748998.175907.c
 */
...
inner:      LU_NUB0 = 507;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+5][LU_IND0*1+5]-16;
         var_b0 = A[LU_IND0*1+5][LU_IND0*1+5-5]-23;
         A[LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5-5][LU_IND0*1+5-5]*4;
         var_a0 = A[LU_IND0*1+5][LU_IND0*1+5]-16;
...
l99999:         ;
      ...
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-16;
         var_b2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5-5]-23;
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-5][(LU_IND0+0)*1+5-5]*4;
         var_a2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-16;

         var_b2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5-5]-23;

         var_a1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-16;
         var_b1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5-5]-23;
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-5][(LU_IND0+1)*1+5-5]*4;
         var_a1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-16;
