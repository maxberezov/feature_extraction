...
/*
 * file for kern_1587749015.322232.c
 */
...
inner:               LU_NUB0 = 14;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+2][b][c] = B[LU_IND0*1+2][b-3][c]*C[LU_IND0*1+2]-A[LU_IND0*1+2][b];
                  A[LU_IND0*1+2][b] = A[LU_IND0*1+2-2][b-4]*40;
                  C[LU_IND0*1+2] = C[LU_IND0*1+2+4]-10;
                  B[LU_IND0*1+2][b][c] = B[LU_IND0*1+2][b+3][c+2]+A[LU_IND0*1+2][b]*C[LU_IND0*1+2];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+2][b][c] = B[(LU_IND0+0)*1+2][b-3][c]*C[(LU_IND0+0)*1+2]-A[(LU_IND0+0)*1+2][b];
                  A[(LU_IND0+0)*1+2][b] = A[(LU_IND0+0)*1+2-2][b-4]*40;
                  C[(LU_IND0+0)*1+2] = C[(LU_IND0+0)*1+2+4]-10;
                  B[(LU_IND0+0)*1+2][b][c] = B[(LU_IND0+0)*1+2][b+3][c+2]+A[(LU_IND0+0)*1+2][b]*C[(LU_IND0+0)*1+2];
                  B[(LU_IND0+1)*1+2][b][c] = B[(LU_IND0+1)*1+2][b-3][c]*C[(LU_IND0+1)*1+2]-A[(LU_IND0+1)*1+2][b];
                  A[(LU_IND0+1)*1+2][b] = A[(LU_IND0+1)*1+2-2][b-4]*40;
                  C[(LU_IND0+1)*1+2] = C[(LU_IND0+1)*1+2+4]-10;
                  B[(LU_IND0+1)*1+2][b][c] = B[(LU_IND0+1)*1+2][b+3][c+2]+A[(LU_IND0+1)*1+2][b]*C[(LU_IND0+1)*1+2];
l99998:                  ;
               }
