...
/*
 * file for kern_1587749011.292936.c
 */
...
inner:         LU_NUB0 = 59;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            var_a0 = A[LU_IND0*1+0]-0;
            var_b0 = A[LU_IND0*1+0]*17;
            A[LU_IND0*1+0] = A[LU_IND0*1+0+1]+D[LU_IND0*1+0]-C[LU_IND0*1+0][b][LU_IND0*1+0]*B[LU_IND0*1+0][b][LU_IND0*1+0];
            B[LU_IND0*1+0][b][LU_IND0*1+0] = B[LU_IND0*1+0+1][b+4][LU_IND0*1+0]-33;
            var_a0 = A[LU_IND0*1+0]-0;

            var_b0 = A[LU_IND0*1+0]*17;

            C[LU_IND0*1+0][b][LU_IND0*1+0] = C[LU_IND0*1+0][b][LU_IND0*1+0]-A[LU_IND0*1+0]*A[LU_IND0*1+0];
            B[LU_IND0*1+0][b][LU_IND0*1+0] = C[LU_IND0*1+0+3][b+1][LU_IND0*1+0+5]+B[LU_IND0*1+0][b][LU_IND0*1+0]-A[LU_IND0*1+0];
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            var_a2 = A[(LU_IND0+0)*1+0]-0;
            var_b2 = A[(LU_IND0+0)*1+0]*17;
            A[(LU_IND0+0)*1+0] = A[(LU_IND0+0)*1+0+1]+D[(LU_IND0+0)*1+0]-C[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0]*B[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0];
            B[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0+1][b+4][(LU_IND0+0)*1+0]-33;
            var_a2 = A[(LU_IND0+0)*1+0]-0;

            var_b2 = A[(LU_IND0+0)*1+0]*17;

            C[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0] = C[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0]-A[(LU_IND0+0)*1+0]*A[(LU_IND0+0)*1+0];
            B[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0] = C[(LU_IND0+0)*1+0+3][b+1][(LU_IND0+0)*1+0+5]+B[(LU_IND0+0)*1+0][b][(LU_IND0+0)*1+0]-A[(LU_IND0+0)*1+0];
            var_a1 = A[(LU_IND0+1)*1+0]-0;
            var_b1 = A[(LU_IND0+1)*1+0]*17;
            A[(LU_IND0+1)*1+0] = A[(LU_IND0+1)*1+0+1]+D[(LU_IND0+1)*1+0]-C[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0]*B[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0];
            B[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0+1][b+4][(LU_IND0+1)*1+0]-33;
            var_a1 = A[(LU_IND0+1)*1+0]-0;

            var_b1 = A[(LU_IND0+1)*1+0]*17;

            C[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0] = C[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0]-A[(LU_IND0+1)*1+0]*A[(LU_IND0+1)*1+0];
            B[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0] = C[(LU_IND0+1)*1+0+3][b+1][(LU_IND0+1)*1+0+5]+B[(LU_IND0+1)*1+0][b][(LU_IND0+1)*1+0]-A[(LU_IND0+1)*1+0];
l99998:            ;
         }
