...
/*
 * file for kern_1587749001.752524.c
 */
...
int main(int argc, const char *argv[])
{
   ...
   int LU_NUB0, LU_IB0, LU_IND0, var_a0, var_b0, var_c0, var_d0, var_e0, var_a1, var_b1, var_c1, var_d1, var_e1, var_a2, var_b2, var_c2, var_d2, var_e2;
   srand(time((void *) 0));
...
inner:               LU_NUB0 = 249;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  var_a0 = A[LU_IND0*1+4][b]*29;
                  var_b0 = B[LU_IND0*1+4]*3;
                  var_c0 = B[LU_IND0*1+4-4]*7;
                  var_d0 = A[LU_IND0*1+4][b]*30;
                  var_e0 = A[LU_IND0*1+4+3][b+2]-4;
                  B[LU_IND0*1+4] = B[LU_IND0*1+4+2]-A[LU_IND0*1+4][b];
                  var_a0 = A[LU_IND0*1+4][b]*29;
...
l99999:                  ;
               ...
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  var_a2 = A[(LU_IND0+0)*1+4][b]*29;
                  var_b2 = B[(LU_IND0+0)*1+4]*3;
                  var_c2 = B[(LU_IND0+0)*1+4-4]*7;
                  var_d2 = A[(LU_IND0+0)*1+4][b]*30;
                  var_e2 = A[(LU_IND0+0)*1+4+3][b+2]-4;
                  B[(LU_IND0+0)*1+4] = B[(LU_IND0+0)*1+4+2]-A[(LU_IND0+0)*1+4][b];
                  var_a2 = A[(LU_IND0+0)*1+4][b]*29;

                  A[(LU_IND0+0)*1+4][b] = 24;
                  var_b2 = B[(LU_IND0+0)*1+4]*3;
                  ...
                  var_a1 = A[(LU_IND0+1)*1+4][b]*29;
                  var_b1 = B[(LU_IND0+1)*1+4]*3;
                  var_c1 = B[(LU_IND0+1)*1+4-4]*7;
                  var_d1 = A[(LU_IND0+1)*1+4][b]*30;
                  var_e1 = A[(LU_IND0+1)*1+4+3][b+2]-4;
                  B[(LU_IND0+1)*1+4] = B[(LU_IND0+1)*1+4+2]-A[(LU_IND0+1)*1+4][b];
                  var_a1 = A[(LU_IND0+1)*1+4][b]*29;

                  A[(LU_IND0+1)*1+4][b] = 24;
                  var_b1 = B[(LU_IND0+1)*1+4]*3;
