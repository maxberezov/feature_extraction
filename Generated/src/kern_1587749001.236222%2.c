...
/*
 * file for kern_1587749001.236222.c
 */
...
inner:               LU_NUB0 = 27;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  A[LU_IND0*1+2][b] = A[LU_IND0*1+2][b-4]-34;
                  A[LU_IND0*1+2][b] = A[LU_IND0*1+2-2][b-5]*9;
                  B[LU_IND0*1+2][b][c] = B[LU_IND0*1+2+3][b+5][c+2]*33;
                  A[LU_IND0*1+2][b] = A[LU_IND0*1+2+5][b+1]*B[LU_IND0*1+2][b][c];
                  A[LU_IND0*1+2][b] = B[LU_IND0*1+2][b][c]+A[LU_IND0*1+2][b];
                  B[LU_IND0*1+2][b][c] = B[LU_IND0*1+2][b+2][c+1]+A[LU_IND0*1+2][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  A[(LU_IND0+0)*1+2][b] = A[(LU_IND0+0)*1+2][b-4]-34;
                  A[(LU_IND0+0)*1+2][b] = A[(LU_IND0+0)*1+2-2][b-5]*9;
                  B[(LU_IND0+0)*1+2][b][c] = B[(LU_IND0+0)*1+2+3][b+5][c+2]*33;
                  A[(LU_IND0+0)*1+2][b] = A[(LU_IND0+0)*1+2+5][b+1]*B[(LU_IND0+0)*1+2][b][c];
                  A[(LU_IND0+0)*1+2][b] = B[(LU_IND0+0)*1+2][b][c]+A[(LU_IND0+0)*1+2][b];
                  B[(LU_IND0+0)*1+2][b][c] = B[(LU_IND0+0)*1+2][b+2][c+1]+A[(LU_IND0+0)*1+2][b];
                  A[(LU_IND0+1)*1+2][b] = A[(LU_IND0+1)*1+2][b-4]-34;
                  A[(LU_IND0+1)*1+2][b] = A[(LU_IND0+1)*1+2-2][b-5]*9;
                  B[(LU_IND0+1)*1+2][b][c] = B[(LU_IND0+1)*1+2+3][b+5][c+2]*33;
                  A[(LU_IND0+1)*1+2][b] = A[(LU_IND0+1)*1+2+5][b+1]*B[(LU_IND0+1)*1+2][b][c];
                  A[(LU_IND0+1)*1+2][b] = B[(LU_IND0+1)*1+2][b][c]+A[(LU_IND0+1)*1+2][b];
                  B[(LU_IND0+1)*1+2][b][c] = B[(LU_IND0+1)*1+2][b+2][c+1]+A[(LU_IND0+1)*1+2][b];
l99998:                  ;
               }
               a = 2+MAX0(LU_NUB0, 0)*1;
            }
         }
      }
   }
