...
/*
 * file for kern_1587748999.028884.c
 */
...
inner:      LU_NUB0 = 6;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5-5][LU_IND0*1+5-1][LU_IND0*1+5]*30;
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5+3][LU_IND0*1+5+5][LU_IND0*1+5+1]-32;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-5][(LU_IND0+0)*1+5-1][(LU_IND0+0)*1+5]*30;
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+3][(LU_IND0+0)*1+5+5][(LU_IND0+0)*1+5+1]-32;
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-5][(LU_IND0+1)*1+5-1][(LU_IND0+1)*1+5]*30;
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+3][(LU_IND0+1)*1+5+5][(LU_IND0+1)*1+5+1]-32;
l99998:         ;
      }
