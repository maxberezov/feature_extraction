...
/*
 * file for kern_1587749009.653588.c
 */
...
int main(int argc, const char *argv[])
{
   ...
   int LU_NUB0, LU_IB0, LU_IND0, var_a0, var_b0, var_a1, var_b1, var_a2, var_b2;
   srand(time((void *) 0));
...
inner:      LU_NUB0 = 7;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = C[LU_IND0*1+5][LU_IND0*1+5]+25;
         var_b0 = C[LU_IND0*1+5][LU_IND0*1+5-3]+14;
         C[LU_IND0*1+5][LU_IND0*1+5] = C[LU_IND0*1+5-3][LU_IND0*1+5-5]+45;
         C[LU_IND0*1+5][LU_IND0*1+5] = C[LU_IND0*1+5+2][LU_IND0*1+5+5]-19+B[LU_IND0*1+5][LU_IND0*1+5];
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5+2][LU_IND0*1+5+1][LU_IND0*1+5+2]-45;
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = C[LU_IND0*1+5][LU_IND0*1+5]-B[LU_IND0*1+5][LU_IND0*1+5];
         var_a0 = C[LU_IND0*1+5][LU_IND0*1+5]+25;

         var_b0 = C[LU_IND0*1+5][LU_IND0*1+5-3]+14;

         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]*C[LU_IND0*1+5][LU_IND0*1+5]+9;
         B[LU_IND0*1+5][LU_IND0*1+5] = A[LU_IND0*1+5-5][LU_IND0*1+5-1][LU_IND0*1+5-5]+B[LU_IND0*1+5][LU_IND0*1+5]*C[LU_IND0*1+5][LU_IND0*1+5];
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]+25;
         var_b2 = C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5-3]+14;
         C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5-3][(LU_IND0+0)*1+5-5]+45;
         C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5+2][(LU_IND0+0)*1+5+5]-19+B[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5+2][(LU_IND0+0)*1+5+1][(LU_IND0+0)*1+5+2]-45;
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-B[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         var_a2 = C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]+25;

         var_b2 = C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5-3]+14;

         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]*C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]+9;
         B[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = A[(LU_IND0+0)*1+5-5][(LU_IND0+0)*1+5-1][(LU_IND0+0)*1+5-5]+B[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]*C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         var_a1 = C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]+25;
         var_b1 = C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5-3]+14;
         C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5-3][(LU_IND0+1)*1+5-5]+45;
         C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5+2][(LU_IND0+1)*1+5+5]-19+B[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5+2][(LU_IND0+1)*1+5+1][(LU_IND0+1)*1+5+2]-45;
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-B[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
         var_a1 = C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]+25;

         var_b1 = C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5-3]+14;

         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]*C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]+9;
         B[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = A[(LU_IND0+1)*1+5-5][(LU_IND0+1)*1+5-1][(LU_IND0+1)*1+5-5]+B[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]*C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
l99998:         ;
      }
