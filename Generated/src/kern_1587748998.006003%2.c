...
/*
 * file for kern_1587748998.006003.c
 */
...
inner:            LU_NUB0 = 10;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               A[LU_IND0*1+3] = A[LU_IND0*1+3+2]*B[LU_IND0*1+3][b][c];
               B[LU_IND0*1+3][b][c] = 1;
               B[LU_IND0*1+3-3][b-3][c-3] = A[LU_IND0*1+3];
               B[LU_IND0*1+3][b][c] = 12;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               A[(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3+2]*B[(LU_IND0+0)*1+3][b][c];
               B[(LU_IND0+0)*1+3][b][c] = 1;
               B[(LU_IND0+0)*1+3-3][b-3][c-3] = A[(LU_IND0+0)*1+3];
               B[(LU_IND0+0)*1+3][b][c] = 12;
               A[(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3+2]*B[(LU_IND0+1)*1+3][b][c];
               B[(LU_IND0+1)*1+3][b][c] = 1;
               B[(LU_IND0+1)*1+3-3][b-3][c-3] = A[(LU_IND0+1)*1+3];
               B[(LU_IND0+1)*1+3][b][c] = 12;
l99998:               ;
            }
