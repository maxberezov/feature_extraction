...
/*
 * file for kern_1587749013.927294.c
 */
...
inner:            LU_NUB0 = 27;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               B[LU_IND0*1+3] = B[LU_IND0*1+3-3]*18;
               B[LU_IND0*1+3] = B[LU_IND0*1+3+3]*A[LU_IND0*1+3][b][c];
               A[LU_IND0*1+3][b][c] = A[LU_IND0*1+3+2][b+2][c+4]-30;
               B[LU_IND0*1+3] = B[LU_IND0*1+3]-A[LU_IND0*1+3][b][c];
               A[LU_IND0*1+3][b][c] = B[LU_IND0*1+3-2]-11;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               B[(LU_IND0+0)*1+3] = B[(LU_IND0+0)*1+3-3]*18;
               B[(LU_IND0+0)*1+3] = B[(LU_IND0+0)*1+3+3]*A[(LU_IND0+0)*1+3][b][c];
               A[(LU_IND0+0)*1+3][b][c] = A[(LU_IND0+0)*1+3+2][b+2][c+4]-30;
               B[(LU_IND0+0)*1+3] = B[(LU_IND0+0)*1+3]-A[(LU_IND0+0)*1+3][b][c];
               A[(LU_IND0+0)*1+3][b][c] = B[(LU_IND0+0)*1+3-2]-11;
               B[(LU_IND0+1)*1+3] = B[(LU_IND0+1)*1+3-3]*18;
               B[(LU_IND0+1)*1+3] = B[(LU_IND0+1)*1+3+3]*A[(LU_IND0+1)*1+3][b][c];
               A[(LU_IND0+1)*1+3][b][c] = A[(LU_IND0+1)*1+3+2][b+2][c+4]-30;
               B[(LU_IND0+1)*1+3] = B[(LU_IND0+1)*1+3]-A[(LU_IND0+1)*1+3][b][c];
               A[(LU_IND0+1)*1+3][b][c] = B[(LU_IND0+1)*1+3-2]-11;
l99998:               ;
            }
