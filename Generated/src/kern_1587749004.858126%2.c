...
/*
 * file for kern_1587749004.858126.c
 */
...
inner:               LU_NUB0 = 10;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  var_a0 = B[LU_IND0*1+4][b][c]-6;
                  var_b0 = B[LU_IND0*1+4+2][b+4][c+5]-30;
                  B[LU_IND0*1+4][b][c] = B[LU_IND0*1+4-4][b-3][c-4]*42;
                  A[LU_IND0*1+4][b] = 50;
                  A[LU_IND0*1+4+1][b+1] = 5;
                  A[LU_IND0*1+4][b] = A[LU_IND0*1+4][b]+B[LU_IND0*1+4][b][c];
                  B[LU_IND0*1+4][b][c] = A[LU_IND0*1+4+4][b+1]-B[LU_IND0*1+4][b][c];
                  var_a0 = B[LU_IND0*1+4][b][c]-6;
...
l99999:                  ;
               ...
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  var_a2 = B[(LU_IND0+0)*1+4][b][c]-6;
                  var_b2 = B[(LU_IND0+0)*1+4+2][b+4][c+5]-30;
                  B[(LU_IND0+0)*1+4][b][c] = B[(LU_IND0+0)*1+4-4][b-3][c-4]*42;
                  A[(LU_IND0+0)*1+4][b] = 50;
                  A[(LU_IND0+0)*1+4+1][b+1] = 5;
                  A[(LU_IND0+0)*1+4][b] = A[(LU_IND0+0)*1+4][b]+B[(LU_IND0+0)*1+4][b][c];
                  B[(LU_IND0+0)*1+4][b][c] = A[(LU_IND0+0)*1+4+4][b+1]-B[(LU_IND0+0)*1+4][b][c];
                  var_a2 = B[(LU_IND0+0)*1+4][b][c]-6;

                  var_b2 = B[(LU_IND0+0)*1+4+2][b+4][c+5]-30;

                  var_a1 = B[(LU_IND0+1)*1+4][b][c]-6;
                  var_b1 = B[(LU_IND0+1)*1+4+2][b+4][c+5]-30;
                  B[(LU_IND0+1)*1+4][b][c] = B[(LU_IND0+1)*1+4-4][b-3][c-4]*42;
                  A[(LU_IND0+1)*1+4][b] = 50;
                  A[(LU_IND0+1)*1+4+1][b+1] = 5;
                  A[(LU_IND0+1)*1+4][b] = A[(LU_IND0+1)*1+4][b]+B[(LU_IND0+1)*1+4][b][c];
                  B[(LU_IND0+1)*1+4][b][c] = A[(LU_IND0+1)*1+4+4][b+1]-B[(LU_IND0+1)*1+4][b][c];
                  var_a1 = B[(LU_IND0+1)*1+4][b][c]-6;
