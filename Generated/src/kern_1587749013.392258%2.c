...
/*
 * file for kern_1587749013.392258.c
 */
...
inner:      LU_NUB0 = 56;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         A[LU_IND0*1+3][LU_IND0*1+3][LU_IND0*1+3] = A[LU_IND0*1+3][LU_IND0*1+3-1][LU_IND0*1+3-3]+B[LU_IND0*1+3][LU_IND0*1+3];
         B[LU_IND0*1+3][LU_IND0*1+3] = A[LU_IND0*1+3][LU_IND0*1+3][LU_IND0*1+3];
         A[LU_IND0*1+3][LU_IND0*1+3][LU_IND0*1+3] = B[LU_IND0*1+3][LU_IND0*1+3]+7;
         A[LU_IND0*1+3][LU_IND0*1+3][LU_IND0*1+3] = A[LU_IND0*1+3+1][LU_IND0*1+3+3][LU_IND0*1+3+5]*16;
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         A[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3][(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3-1][(LU_IND0+0)*1+3-3]+B[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3];
         B[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3][(LU_IND0+0)*1+3];
         A[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3][(LU_IND0+0)*1+3] = B[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3]+7;
         A[(LU_IND0+0)*1+3][(LU_IND0+0)*1+3][(LU_IND0+0)*1+3] = A[(LU_IND0+0)*1+3+1][(LU_IND0+0)*1+3+3][(LU_IND0+0)*1+3+5]*16;
         A[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3][(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3-1][(LU_IND0+1)*1+3-3]+B[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3];
         B[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3][(LU_IND0+1)*1+3];
         A[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3][(LU_IND0+1)*1+3] = B[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3]+7;
         A[(LU_IND0+1)*1+3][(LU_IND0+1)*1+3][(LU_IND0+1)*1+3] = A[(LU_IND0+1)*1+3+1][(LU_IND0+1)*1+3+3][(LU_IND0+1)*1+3+5]*16;
l99998:         ;
      }
