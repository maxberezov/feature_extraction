...
/*
 * file for kern_1587749015.492525.c
 */
...
inner:               LU_NUB0 = 65531;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  A[LU_IND0*1+0] = A[LU_IND0*1+0]-20;
                  A[LU_IND0*1+0] = B[LU_IND0*1+0];
                  B[LU_IND0*1+0] = B[LU_IND0*1+0+5]-1;
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  A[(LU_IND0+0)*1+0] = A[(LU_IND0+0)*1+0]-20;
                  A[(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0];
                  B[(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0+5]-1;
                  A[(LU_IND0+1)*1+0] = A[(LU_IND0+1)*1+0]-20;
                  A[(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0];
                  B[(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0+5]-1;
l99998:                  ;
               }
