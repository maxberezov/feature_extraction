...
/*
 * file for kern_1587749005.468089.c
 */
...
inner:            LU_NUB0 = 16;
            ...
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               C[LU_IND0*1+0][b][c] = C[LU_IND0*1+0][b-1][c]+50;
               B[LU_IND0*1+0][b] = B[LU_IND0*1+0+3][b+3]-C[LU_IND0*1+0][b][c]*A[LU_IND0*1+0][b][c];
               D[LU_IND0*1+0] = B[LU_IND0*1+0][b]+C[LU_IND0*1+0][b][c];
               D[LU_IND0*1+0] = B[LU_IND0*1+0][b];
               A[LU_IND0*1+0][b][c] = 2;
               A[LU_IND0*1+0+5][b+4][c+2] = 13;
               B[LU_IND0*1+0][b] = D[LU_IND0*1+0]-D[LU_IND0*1+0];
               C[LU_IND0*1+0][b][c] = B[LU_IND0*1+0][b]*D[LU_IND0*1+0]-C[LU_IND0*1+0][b][c];
               B[LU_IND0*1+0][b] = B[LU_IND0*1+0][b-1]+C[LU_IND0*1+0][b][c];
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               C[(LU_IND0+0)*1+0][b][c] = C[(LU_IND0+0)*1+0][b-1][c]+50;
               B[(LU_IND0+0)*1+0][b] = B[(LU_IND0+0)*1+0+3][b+3]-C[(LU_IND0+0)*1+0][b][c]*A[(LU_IND0+0)*1+0][b][c];
               D[(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0][b]+C[(LU_IND0+0)*1+0][b][c];
               D[(LU_IND0+0)*1+0] = B[(LU_IND0+0)*1+0][b];
               A[(LU_IND0+0)*1+0][b][c] = 2;
               A[(LU_IND0+0)*1+0+5][b+4][c+2] = 13;
               B[(LU_IND0+0)*1+0][b] = D[(LU_IND0+0)*1+0]-D[(LU_IND0+0)*1+0];
               C[(LU_IND0+0)*1+0][b][c] = B[(LU_IND0+0)*1+0][b]*D[(LU_IND0+0)*1+0]-C[(LU_IND0+0)*1+0][b][c];
               B[(LU_IND0+0)*1+0][b] = B[(LU_IND0+0)*1+0][b-1]+C[(LU_IND0+0)*1+0][b][c];
               C[(LU_IND0+1)*1+0][b][c] = C[(LU_IND0+1)*1+0][b-1][c]+50;
               B[(LU_IND0+1)*1+0][b] = B[(LU_IND0+1)*1+0+3][b+3]-C[(LU_IND0+1)*1+0][b][c]*A[(LU_IND0+1)*1+0][b][c];
               D[(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0][b]+C[(LU_IND0+1)*1+0][b][c];
               D[(LU_IND0+1)*1+0] = B[(LU_IND0+1)*1+0][b];
               A[(LU_IND0+1)*1+0][b][c] = 2;
               A[(LU_IND0+1)*1+0+5][b+4][c+2] = 13;
               B[(LU_IND0+1)*1+0][b] = D[(LU_IND0+1)*1+0]-D[(LU_IND0+1)*1+0];
               C[(LU_IND0+1)*1+0][b][c] = B[(LU_IND0+1)*1+0][b]*D[(LU_IND0+1)*1+0]-C[(LU_IND0+1)*1+0][b][c];
               B[(LU_IND0+1)*1+0][b] = B[(LU_IND0+1)*1+0][b-1]+C[(LU_IND0+1)*1+0][b][c];
l99998:               ;
            }
