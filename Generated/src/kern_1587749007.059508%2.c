...
/*
 * file for kern_1587749007.059508.c
 */
...
inner:               LU_NUB0 = 254;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  B[LU_IND0*1+2][b] = B[LU_IND0*1+2-1][b-3]+10;
                  C[LU_IND0*1+2] = C[LU_IND0*1+2-1]-27;
                  A[LU_IND0*1+2][b] = A[LU_IND0*1+2-2][b-1]+28;
                  C[LU_IND0*1+2] = C[LU_IND0*1+2+1]+B[LU_IND0*1+2][b];
l99999:                  ;
               }
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  B[(LU_IND0+0)*1+2][b] = B[(LU_IND0+0)*1+2-1][b-3]+10;
                  C[(LU_IND0+0)*1+2] = C[(LU_IND0+0)*1+2-1]-27;
                  A[(LU_IND0+0)*1+2][b] = A[(LU_IND0+0)*1+2-2][b-1]+28;
                  C[(LU_IND0+0)*1+2] = C[(LU_IND0+0)*1+2+1]+B[(LU_IND0+0)*1+2][b];
                  B[(LU_IND0+1)*1+2][b] = B[(LU_IND0+1)*1+2-1][b-3]+10;
                  C[(LU_IND0+1)*1+2] = C[(LU_IND0+1)*1+2-1]-27;
                  A[(LU_IND0+1)*1+2][b] = A[(LU_IND0+1)*1+2-2][b-1]+28;
                  C[(LU_IND0+1)*1+2] = C[(LU_IND0+1)*1+2+1]+B[(LU_IND0+1)*1+2][b];
l99998:                  ;
               }
