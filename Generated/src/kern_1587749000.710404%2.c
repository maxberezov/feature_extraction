...
/*
 * file for kern_1587749000.710404.c
 */
...
inner:      LU_NUB0 = 65531;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+2]*15;
         var_b0 = A[LU_IND0*1+2-2]+27;
         A[LU_IND0*1+2] = A[LU_IND0*1+2+3]-B[LU_IND0*1+2][LU_IND0*1+2];
         var_a0 = A[LU_IND0*1+2]*15;
...
l99999:         ;
      ...
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+2]*15;
         var_b2 = A[(LU_IND0+0)*1+2-2]+27;
         A[(LU_IND0+0)*1+2] = A[(LU_IND0+0)*1+2+3]-B[(LU_IND0+0)*1+2][(LU_IND0+0)*1+2];
         var_a2 = A[(LU_IND0+0)*1+2]*15;

         var_b2 = A[(LU_IND0+0)*1+2-2]+27;

         var_a1 = A[(LU_IND0+1)*1+2]*15;
         var_b1 = A[(LU_IND0+1)*1+2-2]+27;
         A[(LU_IND0+1)*1+2] = A[(LU_IND0+1)*1+2+3]-B[(LU_IND0+1)*1+2][(LU_IND0+1)*1+2];
         var_a1 = A[(LU_IND0+1)*1+2]*15;
