...
/*
 * file for kern_1587749014.283363.c
 */
...
inner:               LU_NUB0 = 27;
               ...
               for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
                  var_a0 = B[LU_IND0*1+1][b]-49;
                  var_b0 = B[LU_IND0*1+1+3][b]+43;
                  C[LU_IND0*1+1] = C[LU_IND0*1+1-1]-B[LU_IND0*1+1][b];
                  A[LU_IND0*1+1][b][c] = A[LU_IND0*1+1+4][b+1][c+4]-C[LU_IND0*1+1]*23;
                  var_a0 = B[LU_IND0*1+1][b]-49;
...
l99999:                  ;
               ...
               for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
                  var_a2 = B[(LU_IND0+0)*1+1][b]-49;
                  var_b2 = B[(LU_IND0+0)*1+1+3][b]+43;
                  C[(LU_IND0+0)*1+1] = C[(LU_IND0+0)*1+1-1]-B[(LU_IND0+0)*1+1][b];
                  A[(LU_IND0+0)*1+1][b][c] = A[(LU_IND0+0)*1+1+4][b+1][c+4]-C[(LU_IND0+0)*1+1]*23;
                  var_a2 = B[(LU_IND0+0)*1+1][b]-49;

                  var_b2 = B[(LU_IND0+0)*1+1+3][b]+43;

                  var_a1 = B[(LU_IND0+1)*1+1][b]-49;
                  var_b1 = B[(LU_IND0+1)*1+1+3][b]+43;
                  C[(LU_IND0+1)*1+1] = C[(LU_IND0+1)*1+1-1]-B[(LU_IND0+1)*1+1][b];
                  A[(LU_IND0+1)*1+1][b][c] = A[(LU_IND0+1)*1+1+4][b+1][c+4]-C[(LU_IND0+1)*1+1]*23;
                  var_a1 = B[(LU_IND0+1)*1+1][b]-49;
