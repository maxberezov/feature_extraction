...
/*
 * file for kern_1587748998.516653.c
 */
...
inner:      LU_NUB0 = 11;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+0][LU_IND0*1+0][LU_IND0*1+0]*43;
         var_b0 = A[LU_IND0*1+0+4][LU_IND0*1+0+5][LU_IND0*1+0]+22;
         D[LU_IND0*1+0][LU_IND0*1+0] = 42;
         D[LU_IND0*1+0+4][LU_IND0*1+0+4] = 38;
         var_a0 = A[LU_IND0*1+0][LU_IND0*1+0][LU_IND0*1+0]*43;
...
l99999:         ;
      ...
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0][(LU_IND0+0)*1+0]*43;
         var_b2 = A[(LU_IND0+0)*1+0+4][(LU_IND0+0)*1+0+5][(LU_IND0+0)*1+0]+22;
         D[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0] = 42;
         D[(LU_IND0+0)*1+0+4][(LU_IND0+0)*1+0+4] = 38;
         var_a2 = A[(LU_IND0+0)*1+0][(LU_IND0+0)*1+0][(LU_IND0+0)*1+0]*43;

         var_b2 = A[(LU_IND0+0)*1+0+4][(LU_IND0+0)*1+0+5][(LU_IND0+0)*1+0]+22;

         var_a1 = A[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0][(LU_IND0+1)*1+0]*43;
         var_b1 = A[(LU_IND0+1)*1+0+4][(LU_IND0+1)*1+0+5][(LU_IND0+1)*1+0]+22;
         D[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0] = 42;
         D[(LU_IND0+1)*1+0+4][(LU_IND0+1)*1+0+4] = 38;
         var_a1 = A[(LU_IND0+1)*1+0][(LU_IND0+1)*1+0][(LU_IND0+1)*1+0]*43;
