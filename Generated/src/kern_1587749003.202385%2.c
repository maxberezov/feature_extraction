...
/*
 * file for kern_1587749003.202385.c
 */
...
inner:         LU_NUB0 = 8;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            A[LU_IND0*1+4][b][LU_IND0*1+4] = A[LU_IND0*1+4-4][b-5][LU_IND0*1+4-4]+42;
            A[LU_IND0*1+4][b][LU_IND0*1+4] = A[LU_IND0*1+4+2][b+2][LU_IND0*1+4+2]+B[LU_IND0*1+4];
            A[LU_IND0*1+4][b][LU_IND0*1+4] = A[LU_IND0*1+4][b][LU_IND0*1+4]*48;
            B[LU_IND0*1+4] = A[LU_IND0*1+4][b+4][LU_IND0*1+4+4]*49;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            A[(LU_IND0+0)*1+4][b][(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4-4][b-5][(LU_IND0+0)*1+4-4]+42;
            A[(LU_IND0+0)*1+4][b][(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4+2][b+2][(LU_IND0+0)*1+4+2]+B[(LU_IND0+0)*1+4];
            A[(LU_IND0+0)*1+4][b][(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4][b][(LU_IND0+0)*1+4]*48;
            B[(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4][b+4][(LU_IND0+0)*1+4+4]*49;
            A[(LU_IND0+1)*1+4][b][(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4-4][b-5][(LU_IND0+1)*1+4-4]+42;
            A[(LU_IND0+1)*1+4][b][(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4+2][b+2][(LU_IND0+1)*1+4+2]+B[(LU_IND0+1)*1+4];
            A[(LU_IND0+1)*1+4][b][(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4][b][(LU_IND0+1)*1+4]*48;
            B[(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4][b+4][(LU_IND0+1)*1+4+4]*49;
l99998:            ;
         }
