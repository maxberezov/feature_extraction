...
/*
 * file for kern_1587749004.114872.c
 */
...
inner:         LU_NUB0 = 31;
         ...
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            A[LU_IND0*1+1][b][LU_IND0*1+1] = A[LU_IND0*1+1][b-2][LU_IND0*1+1-1]+13*B[LU_IND0*1+1]-C[LU_IND0*1+1][b][LU_IND0*1+1]+E[LU_IND0*1+1][b];
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            A[(LU_IND0+0)*1+1][b][(LU_IND0+0)*1+1] = A[(LU_IND0+0)*1+1][b-2][(LU_IND0+0)*1+1-1]+13*B[(LU_IND0+0)*1+1]-C[(LU_IND0+0)*1+1][b][(LU_IND0+0)*1+1]+E[(LU_IND0+0)*1+1][b];
            A[(LU_IND0+1)*1+1][b][(LU_IND0+1)*1+1] = A[(LU_IND0+1)*1+1][b-2][(LU_IND0+1)*1+1-1]+13*B[(LU_IND0+1)*1+1]-C[(LU_IND0+1)*1+1][b][(LU_IND0+1)*1+1]+E[(LU_IND0+1)*1+1][b];
l99998:            ;
         }
