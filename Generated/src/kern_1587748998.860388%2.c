...
/*
 * file for kern_1587748998.860388.c
 */
...
extern time_t mktime(struct tm {int tm_sec; int tm_min; int tm_hour; int tm_mday; int tm_mon; int tm_year; int tm_wday; int tm_yday; int tm_isdst; long int __tm_gmtoff; const char *__tm_zone;} *__tp);
...
int main(int argc, const char *argv[])
{
   ...
   int LU_NUB0, LU_IB0, LU_IND0, var_a0, var_b0, var_c0, var_d0, var_a1, var_b1, var_c1, var_d1, var_a2, var_b2, var_c2, var_d2;
   srand(time((void *) 0));
...
inner:      LU_NUB0 = 54;
      ...
      for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
         var_a0 = A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]-21;
         var_b0 = A[LU_IND0*1+5+5][LU_IND0*1+5+1][LU_IND0*1+5+5]*38;
         var_c0 = A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]+21;
         var_d0 = A[LU_IND0*1+5][LU_IND0*1+5+5][LU_IND0*1+5+2]+27;
         var_a0 = A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]-21;
         ...
         B[LU_IND0*1+5] = B[LU_IND0*1+5]*C[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5];
         C[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = B[LU_IND0*1+5-5]-A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]+C[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5];
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = B[LU_IND0*1+5]*C[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5];
         A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5] = B[LU_IND0*1+5+3]+A[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5]-C[LU_IND0*1+5][LU_IND0*1+5][LU_IND0*1+5];
l99999:         ;
      }
      for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
         var_a2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-21;
         var_b2 = A[(LU_IND0+0)*1+5+5][(LU_IND0+0)*1+5+1][(LU_IND0+0)*1+5+5]*38;
         var_c2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]+21;
         var_d2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5+5][(LU_IND0+0)*1+5+2]+27;
         var_a2 = A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-21;
         ...
         B[(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5]*C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5-5]-A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]+C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5]*C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5] = B[(LU_IND0+0)*1+5+3]+A[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5]-C[(LU_IND0+0)*1+5][(LU_IND0+0)*1+5][(LU_IND0+0)*1+5];
         var_a1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-21;
         var_b1 = A[(LU_IND0+1)*1+5+5][(LU_IND0+1)*1+5+1][(LU_IND0+1)*1+5+5]*38;
         var_c1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]+21;
         var_d1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5+5][(LU_IND0+1)*1+5+2]+27;
         var_a1 = A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-21;
         ...
         B[(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5]*C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
         C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5-5]-A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]+C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5]*C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
         A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5] = B[(LU_IND0+1)*1+5+3]+A[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5]-C[(LU_IND0+1)*1+5][(LU_IND0+1)*1+5][(LU_IND0+1)*1+5];
l99998:         ;
      }
      a = 5+MAX0(LU_NUB0, 0)*1;
   }
