...
/*
 * file for kern_1587749013.210712.c
 */
...
int main(int argc, const char *argv[])
{
   ...
   clock_t start = clock();
   {
      ...
      for(b = 1; b <= 262143; b += 1) {
         int a;
inner:         LU_NUB0 = 262143;
         LU_IB0 = 1;
         for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
            A[LU_IND0*1+1] = A[LU_IND0*1+1-1]-37;
l99999:            ;
         }
         for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
            A[(LU_IND0+0)*1+1] = A[(LU_IND0+0)*1+1-1]-37;
            A[(LU_IND0+1)*1+1] = A[(LU_IND0+1)*1+1-1]-37;
l99998:            ;
         }
