...
/*
 * file for kern_1587749009.828687.c
 */
   ...
   clock_t start = clock();
   {
      ...
      for(c = 4; c <= 524287; c += 1) {
         ...
         for(b = 4; b <= 524287; b += 1) {
            int a;
inner:            LU_NUB0 = 524284;
            LU_IB0 = 0;
            for(LU_IND0 = 0; LU_IND0 <= LU_IB0-1; LU_IND0 += 1) {
               A[LU_IND0*1+4] = A[LU_IND0*1+4-4]*26;
               A[LU_IND0*1+4] = 49;
l99999:               ;
            }
            for(LU_IND0 = LU_IB0; LU_IND0 <= LU_NUB0-1; LU_IND0 += 2) {
               A[(LU_IND0+0)*1+4] = A[(LU_IND0+0)*1+4-4]*26;
               A[(LU_IND0+0)*1+4] = 49;
               A[(LU_IND0+1)*1+4] = A[(LU_IND0+1)*1+4-4]*26;
               A[(LU_IND0+1)*1+4] = 49;
l99998:               ;
            }
