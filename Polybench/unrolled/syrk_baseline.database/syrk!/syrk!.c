...
# 25 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_baseline/linear-algebra/blas/syrk/syrk.c"
static void init_array(int n, int m, double *alpha, double *beta, double C [ 1200 + 0 ] [ 1200 + 0 ], double A [ 1200 + 0 ] [ 1000 + 0 ]);


/* DCE code. Must scan the entire live-out data.
   Can be used also to check the correctness of the output. */
# 47 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_baseline/linear-algebra/blas/syrk/syrk.c"
...
# 96 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_baseline/linear-algebra/blas/syrk/syrk.c"
