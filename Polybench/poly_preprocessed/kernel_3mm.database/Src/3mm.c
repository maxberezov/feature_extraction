...
void kernel_3mm(int ni, int nj, int nk, int nl, int nm, double E[800+0][900+0], double A[800+0][1000+0], double B[1000+0][900+0], double F[900+0][1100+0], double C[900+0][1200+0], double D[1200+0][1100+0], double G[800+0][1100+0])
{
   int i, j, k;
...
int main(int argc, char **argv)
{
   ...
   E = (double (*)[800+0][900+0]) polybench_alloc_data((800+0)*(900+0), sizeof(double));
   double (*A)[800+0][1000+0];
   A = (double (*)[800+0][1000+0]) polybench_alloc_data((800+0)*(1000+0), sizeof(double));
   double (*B)[1000+0][900+0];
   B = (double (*)[1000+0][900+0]) polybench_alloc_data((1000+0)*(900+0), sizeof(double));
   double (*F)[900+0][1100+0];
   F = (double (*)[900+0][1100+0]) polybench_alloc_data((900+0)*(1100+0), sizeof(double));
   double (*C)[900+0][1200+0];
   C = (double (*)[900+0][1200+0]) polybench_alloc_data((900+0)*(1200+0), sizeof(double));
   double (*D)[1200+0][1100+0];
   D = (double (*)[1200+0][1100+0]) polybench_alloc_data((1200+0)*(1100+0), sizeof(double));
   double (*G)[800+0][1100+0];
   G = (double (*)[800+0][1100+0]) polybench_alloc_data((800+0)*(1100+0), sizeof(double));
