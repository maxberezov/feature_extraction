...
static void print_array(int m, int n, double s [ 1900 + 0 ], double q [ 2100 + 0 ]);


/* Main computational kernel. The whole function will be timed,
including the call and return. */
# 72 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/linear-algebra/kernels/bicg/bicg.c"
extern void kernel_bicg(int m, int n, double A [ 2100 + 0 ] [ 1900 + 0 ], double s [ 1900 + 0 ], double q [ 2100 + 0 ], double p [ 1900 + 0 ], double r [ 2100 + 0 ]);


# 113 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/linear-algebra/kernels/bicg/bicg.c"
