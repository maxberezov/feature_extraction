...
# 25 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/linear-algebra/solvers/trisolv/trisolv.c"
static void init_array(int n, double L [ 2000 + 0 ] [ 2000 + 0 ], double x [ 2000 + 0 ], double b [ 2000 + 0 ]);


/* DCE code. Must scan the entire live-out data.
Can be used also to check the correctness of the output. */
# 45 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/linear-algebra/solvers/trisolv/trisolv.c"
...
extern void kernel_trisolv(int n, double L [ 2000 + 0 ] [ 2000 + 0 ], double x [ 2000 + 0 ], double b [ 2000 + 0 ]);


# 92 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/linear-algebra/solvers/trisolv/trisolv.c"
