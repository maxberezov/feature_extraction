...
void kernel_deriche(int w, int h, float alpha, float imgIn[4096+0][2160+0], float imgOut[4096+0][2160+0], float y1[4096+0][2160+0], float y2[4096+0][2160+0])
{
   int i, j;
...
int main(int argc, char **argv)
{
   ...
   imgIn = (float (*)[4096+0][2160+0]) polybench_alloc_data((4096+0)*(2160+0), sizeof(float));
   float (*imgOut)[4096+0][2160+0];
   imgOut = (float (*)[4096+0][2160+0]) polybench_alloc_data((4096+0)*(2160+0), sizeof(float));
   float (*y1)[4096+0][2160+0];
   y1 = (float (*)[4096+0][2160+0]) polybench_alloc_data((4096+0)*(2160+0), sizeof(float));
   float (*y2)[4096+0][2160+0];
   y2 = (float (*)[4096+0][2160+0]) polybench_alloc_data((4096+0)*(2160+0), sizeof(float));
