...
int main(int argc, char **argv)
{
   ...
   u = (double (*)[1000+0][1000+0]) polybench_alloc_data((1000+0)*(1000+0), sizeof(double));
   double (*v)[1000+0][1000+0];
   v = (double (*)[1000+0][1000+0]) polybench_alloc_data((1000+0)*(1000+0), sizeof(double));
   double (*p)[1000+0][1000+0];
   p = (double (*)[1000+0][1000+0]) polybench_alloc_data((1000+0)*(1000+0), sizeof(double));
   double (*q)[1000+0][1000+0];
   q = (double (*)[1000+0][1000+0]) polybench_alloc_data((1000+0)*(1000+0), sizeof(double));
