...
void kernel_2mm(int ni, int nj, int nk, int nl, double alpha, double beta, double tmp[800+0][900+0], double A[800+0][1100+0], double B[1100+0][900+0], double C[900+0][1200+0], double D[800+0][1200+0])
{
   int i, j, k;
...
int main(int argc, char **argv)
{
   ...
   tmp = (double (*)[800+0][900+0]) polybench_alloc_data((800+0)*(900+0), sizeof(double));
   double (*A)[800+0][1100+0];
   A = (double (*)[800+0][1100+0]) polybench_alloc_data((800+0)*(1100+0), sizeof(double));
   double (*B)[1100+0][900+0];
   B = (double (*)[1100+0][900+0]) polybench_alloc_data((1100+0)*(900+0), sizeof(double));
   double (*C)[900+0][1200+0];
   C = (double (*)[900+0][1200+0]) polybench_alloc_data((900+0)*(1200+0), sizeof(double));
   double (*D)[800+0][1200+0];
   D = (double (*)[800+0][1200+0]) polybench_alloc_data((800+0)*(1200+0), sizeof(double));
