...
int main(int argc, char **argv)
{
   ...
   A = (double (*)[1900+0][2100+0]) polybench_alloc_data((1900+0)*(2100+0), sizeof(double));
   double (*x)[2100+0];
   x = (double (*)[2100+0]) polybench_alloc_data(2100+0, sizeof(double));
   double (*y)[2100+0];
   y = (double (*)[2100+0]) polybench_alloc_data(2100+0, sizeof(double));
   double (*tmp)[1900+0];
