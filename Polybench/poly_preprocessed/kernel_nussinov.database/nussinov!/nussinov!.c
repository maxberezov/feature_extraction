...
# 30 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/medley/nussinov/nussinov.c"
static void init_array(int n, base seq [ 2500 + 0 ], int table [ 2500 + 0 ] [ 2500 + 0 ]);


/* DCE code. Must scan the entire live-out data.
   Can be used also to check the correctness of the output. */
# 50 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/medley/nussinov/nussinov.c"
 ...
 */
# 79 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/medley/nussinov/nussinov.c"
extern void kernel_nussinov(int n, base seq [ 2500 + 0 ], int table [ 2500 + 0 ] [ 2500 + 0 ]);
