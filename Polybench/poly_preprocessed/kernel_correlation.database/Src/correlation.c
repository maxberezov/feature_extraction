...
int main(int argc, char **argv)
{
   ...
   data = (double (*)[1400+0][1200+0]) polybench_alloc_data((1400+0)*(1200+0), sizeof(double));
   double (*corr)[1200+0][1200+0];
   corr = (double (*)[1200+0][1200+0]) polybench_alloc_data((1200+0)*(1200+0), sizeof(double));
   double (*mean)[1200+0];
   mean = (double (*)[1200+0]) polybench_alloc_data(1200+0, sizeof(double));
   double (*stddev)[1200+0];
   stddev = (double (*)[1200+0]) polybench_alloc_data(1200+0, sizeof(double));
