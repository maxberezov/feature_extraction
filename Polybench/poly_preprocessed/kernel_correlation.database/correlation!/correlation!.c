...
# 25 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/datamining/correlation/correlation.c"
static void init_array(int m, int n, double *float_n, double data [ 1400 + 0 ] [ 1200 + 0 ]);


/* DCE code. Must scan the entire live-out data.
   Can be used also to check the correctness of the output. */
# 44 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/datamining/correlation/correlation.c"
static void print_array(int m, double corr [ 1200 + 0 ] [ 1200 + 0 ]);


/* Main computational kernel. The whole function will be timed,
   including the call and return. */
# 65 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/datamining/correlation/correlation.c"
extern void kernel_correlation(int m, int n, double float_n, double data [ 1400 + 0 ] [ 1200 + 0 ], double corr [ 1200 + 0 ] [ 1200 + 0 ], double mean [ 1200 + 0 ], double stddev [ 1200 + 0 ]);


# 155 "/home/maksim/PycharmProjects/unrolling/Polybench/poly_preprocessed/datamining/correlation/correlation.c"
