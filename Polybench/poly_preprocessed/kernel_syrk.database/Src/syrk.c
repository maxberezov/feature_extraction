...
void kernel_syrk(int n, int m, double alpha, double beta, double C[1200+0][1200+0], double A[1200+0][1000+0])
{
   int i, j, k;
...
int main(int argc, char **argv)
{
   ...
   A = (double (*)[1200+0][1000+0]) polybench_alloc_data((1200+0)*(1000+0), sizeof(double));
