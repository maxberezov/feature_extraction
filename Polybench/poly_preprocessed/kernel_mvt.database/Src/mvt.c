...
int main(int argc, char **argv)
{
   ...
   double (*x1)[2000+0];
   x1 = (double (*)[2000+0]) polybench_alloc_data(2000+0, sizeof(double));
   double (*x2)[2000+0];
   x2 = (double (*)[2000+0]) polybench_alloc_data(2000+0, sizeof(double));
   double (*y_1)[2000+0];
   y_1 = (double (*)[2000+0]) polybench_alloc_data(2000+0, sizeof(double));
   double (*y_2)[2000+0];
   y_2 = (double (*)[2000+0]) polybench_alloc_data(2000+0, sizeof(double));
