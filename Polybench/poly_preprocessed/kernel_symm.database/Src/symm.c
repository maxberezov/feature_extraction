...
void kernel_symm(int m, int n, double alpha, double beta, double C[1000+0][1200+0], double A[1000+0][1000+0], double B[1000+0][1200+0])
{
   int i, j, k;
   double temp2;
...
int main(int argc, char **argv)
{
   ...
   C = (double (*)[1000+0][1200+0]) polybench_alloc_data((1000+0)*(1200+0), sizeof(double));
